function ReporteAceites(year, mes) {
  $("#DivReporteAceites").html(
    '<div class="text-center mt-5 pt-5"><img class="mt-5 pt-5" width="50px" src="../../imgs/iconos/load-img.gif"></div>'
  );
  $("#DivReporteAceites").load(
    "../../app/vistas/personal-general/1-corporativo/corte-diario/aceites/reporte-aceites-mes.php?year=" +
      year +
      "&mes=" +
      mes
  );
...
function ModalDiferencia(idaceite, year, mes) {
  ...
  $("#DivModal").load(
    "../../app/vistas/personal-general/1-corporativo/corte-diario/aceites/modal-pago-aceite.php?idaceite=" +
      idaceite +
      "&year=" +
      year +
      "&mes=" +
...
function ModalDetalle(idaceite) {
  $("#ModalPrincipal").modal("show");
  $("#DivModal").load(
    "../../app/vistas/personal-general/1-corporativo/corte-diario/aceites/modal-detalle-pago-aceite.php?idaceite=" +
      idaceite
  );
...
function GuardarFinalizar(IdReporte, idEstacion, nombreEstacion) {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      $("#ModalPrincipal").modal("show");
      $("#DivModal").load(
        "../../app/vistas/personal-general/1-corporativo/corte-diario/aceites/modal-info-diferencias.php"
      );
...
function ListaModal(IdReporte, year, mes) {
  $("#Modal").modal("show");
  $("#ListaDocumento").load(
    "../../app/vistas/personal-general/1-corporativo/corte-diario/aceites/lista-aceites-documento.php?IdReporte=" +
      IdReporte +
      "&year=" +
      year +
      "&mes=" +
...
function Nuevo(IdReporte, year, mes) {
  $("#ListaDocumento").load(
    "../../app/vistas/personal-general/1-corporativo/corte-diario/aceites/formulario-aceites-documento.php?IdReporte=" +
      IdReporte +
      "&year=" +
      year +
      "&mes=" +
...
function Editar(IdReporte, year, mes, id) {
  $("#ListaDocumento").load(
    "../../app/vistas/personal-general/1-corporativo/corte-diario/aceites/editar-aceite-documento.php?IdReporte=" +
      IdReporte +
      "&year=" +
      year +
      "&mes=" +
...
function DocumentacionAceites(IdReporte, year, mes) {
  $("#Modal").modal("show");
  $("#ListaDocumento").load(
    "../../app/vistas/personal-general/1-corporativo/corte-diario/aceites/lista-aceites-facturas.php?IdReporte=" +
      IdReporte +
      "&year=" +
      year +
      "&mes=" +
