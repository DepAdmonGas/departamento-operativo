function Mas(idReporte, idEstacion, year, mes) {
  $("#Modal").modal("show");
  $("#ModalEmbarques").load(
    "../../app/vistas/contenido/1-corporativo/corte-diario/embarques/modal-embarques-mes.php?idReporte=" +
      idReporte +
      "&idEstacion=" +
      idEstacion +
      "&year=" +
...
function Editar(idReporte, id, idestacion, year, mes) {
  $("#Modal").modal("show");
  $("#ModalEmbarques").load(
    "../../app/vistas/contenido/1-corporativo/corte-diario/embarques/modal-editar-embarques-mes.php?idReporte=" +
      idReporte +
      "&id=" +
      id +
      "&idestacion=" +
...
function ModalComentario(idReporte, id, idEstacion, year, mes) {
  ...
  $("#DivModalComentario").load(
    "../../app/vistas/contenido/1-corporativo/corte-diario/embarques/modal-comentarios-embarques.php?idReporte=" +
      idReporte +
      "&id=" +
      id +
      "&idestacion=" +
