...
<html lang="es">
  ...
  $('#ListaTransaccion').load('public/corte-diario/vistas/lista-refacciones-transaccion.php', function() {
  ...
  <li aria-current="page" class="breadcrumb-item active text-uppercase">Transacción de Refacciones</li>
  </ol>
  </div>
 
  <div class="row"> 
  <div class="col-12"> <h3 class="text-secondary" style="padding-left: 0; margin-bottom: 0; margin-top: 0;">Transacción de Refacciones</h3> </div>
  </div>
  
  <hr>
  </div>  

  <div class="col-12" id="ListaTransaccion"></div>
