...
<th class="align-middle bg-light text-center"  width="20px"><img width="20px" src="<?=RUTA_IMG_ICONOS;?>pdf.png"></th>
...
<table class="table table-bordered pb-0 mb-0" style="font-size: 1em;">
	...
	<tr>
		...
		<td class="text-end pl-4 pr-2 font-weight-light">$ <?=number_format(Resumen($idReporte,'Débito','Consumo',$con),2);?></td>
		<td class="text-end pl-4 pr-2 font-weight-light">$ <?=number_format(Resumen($idReporte,'Débito','Pago',$con),2);?></td>
	</tr>
	<tr>
		<td class="text-primary pl-4 pr-4 text-center font-weight-light">Crédito</td>
		<td class="text-end pl-4 pr-2 font-weight-light">$ <?=number_format(Resumen($idReporte,'Crédito','Consumo',$con),2);?></td>
		<td class="text-end pl-4 pr-2 font-weight-light">$ <?=number_format(Resumen($idReporte,'Crédito','Pago',$con),2);?></td>
	</tr>
</table>
