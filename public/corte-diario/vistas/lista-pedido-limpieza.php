...
$sql_lista = "SELECT * FROM op_pedido_limpieza WHERE id_estacion = '".$Session_IDEstacion."' ORDER BY id DESC";
...
<thead class="tables-bg">
 <tr>
  ...
  <th class="align-middle tableStyle font-weight-bold">Personal</th>
  <th class="align-middle tableStyle font-weight-bold">Fecha y hora</th>  
