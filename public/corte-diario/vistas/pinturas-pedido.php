...
function FinalizarPedido(idReporte){
 ...
 function(){
  ...
  <div class="border-0 p-3">
    ...
    <div class="col-1">
    <img src="<?=RUTA_IMG_ICONOS;?>agregar.png" class="float-end pointer" onclick="Agregar(<?=$idReporte;?>)">
    </div>
  ...
  <textarea class="form-control rounded-0" id="Observaciones" style="width: 100%; height: 150px;"><?=$observaciones;?></textarea>
  </div>
