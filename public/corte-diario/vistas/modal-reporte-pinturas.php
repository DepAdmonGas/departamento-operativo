...
<div class="modal-body">
        ...
        <div class="mb-1 text-secondary">Pintura o complemento:</div>
        <select class="selectize pointer" placeholder="Producto" id="Producto">
        <option value="">Selecciona</option>
        <?php 
        $sql_lista = "SELECT * FROM op_inventario_pinturas WHERE id_estacion = '".$Session_IDEstacion."' AND piezas > 0 AND status = 1 ORDER BY id ASC";
        ...
        <div class="col-12 ">
        <div class="mb-2 text-secondary">Observación:</div>
...
<button type="button" class="btn btn-success" onclick="AgregarItemReporte(<?=$idReporte;?>)">Agregar</button>
      </div>