...
$sql_reporte = "SELECT * FROM op_pinturas_complementos_reporte WHERE id = '".$GET_idReporte."' ";
...
<html lang="es">
  ...
  function ListaPinturas(idReporte){
  $('#ListaPinturasMaterial').load('../public/corte-diario/vistas/lista-reporte-material-pinturas.php?idReporte=' + idReporte);  
  } 

  function AgregarReporte(idReporte){
  $('#Modal').modal('show');  
  $('#ContenidoModal').load('../public/corte-diario/vistas/modal-reporte-pinturas.php?idReporte=' + idReporte);
  } 
    ...
    $.ajax({
    data:  parametros,
    url:   '../public/corte-diario/modelo/agregar-pinturas-reporte.php',
    type:  'post',
    beforeSend: function() {
    },
    complete: function(){
   ...
   function(){
      ...
      $.ajax({
    data:  parametros,
    url:   '../public/corte-diario/modelo/eliminar-pinturas-reporte.php',
    type:  'post',
    beforeSend: function() {
    },
    complete: function(){
 ...
 function(){
    ...
    $.ajax({
    data:  parametros,
    url:   '../public/corte-diario/modelo/finalizar-pinturas-reporte.php',
    type:  'post',
    beforeSend: function() {
    },
    complete: function(){
  ...
  <div class="border-0 p-3">
    ...
    <h5>Agregar reporte de pinturas</h5>
  ...
  <div class="col-1">
  <img src="<?=RUTA_IMG_ICONOS;?>agregar.png" class="float-end pointer" onclick="AgregarReporte(<?=$GET_idReporte;?>)">
  ...
  <div class="row">
    ...
    <div id="ListaPinturasMaterial"></div>
    </div>
