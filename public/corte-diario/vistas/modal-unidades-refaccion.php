...
<h6 class="mb-1 text-secondary ">Refacción:</h6>
<img class="float-center" src="archivos/<?=$imagen;?>" width="150px">
</div>
</div>
...
<div class="text-end">
<button type="button" class="btn btn-primary btn-sm rounded-0" onclick="AgregarPiezas(<?=$idRefaccion;?>)">Agregar</button>
</div>
