			...
			<table class="table table-sm table-bordered mb-0" style="font-size: .9em;">
				...
				<tbody>
					...
					while ($rowP1 = mysqli_fetch_array($resultP1, MYSQLI_ASSOC)) {
						...
						<tr>
							<td><?= $rowP1['detalle']; ?></td>
							<td class="align-middle p-0"><input id="D11<?= $id; ?>"
									class="form-control border-0 rounded-0 text-end" type="number" step="any" min="0"
									value="<?= $enero1; ?>" style="font-size: .9em;"
									onkeyup="EditIF(<?= $idReporte; ?>,<?= $id; ?>,1,1)"></td>
							<td class="align-middle p-0"><input id="D12<?= $id; ?>"
									class="form-control border-0 rounded-0 text-end" type="number" step="any" min="0"
									value="<?= $febrero1; ?>" style="font-size: .9em;"
									onkeyup="EditIF(<?= $idReporte; ?>,<?= $id; ?>,2,1)"></td>
							<td class="align-middle p-0"><input id="D13<?= $id; ?>"
									class="form-control border-0 rounded-0 text-end" type="number" step="any" min="0"
									value="<?= $marzo1; ?>" style="font-size: .9em;"
									onkeyup="EditIF(<?= $idReporte; ?>,<?= $id; ?>,3,1)"></td>
							<td class="align-middle p-0"><input id="D14<?= $id; ?>"
									class="form-control border-0 rounded-0 text-end" type="number" step="any" min="0"
									value="<?= $abril1; ?>" style="font-size: .9em;"
									onkeyup="EditIF(<?= $idReporte; ?>,<?= $id; ?>,4,1)"></td>
							<td class="align-middle p-0"><input id="D15<?= $id; ?>"
									class="form-control border-0 rounded-0 text-end" type="number" step="any" min="0"
									value="<?= $mayo1; ?>" style="font-size: .9em;"
									onkeyup="EditIF(<?= $idReporte; ?>,<?= $id; ?>,5,1)"></td>
							<td class="align-middle p-0"><input id="D16<?= $id; ?>"
									class="form-control border-0 rounded-0 text-end" type="number" step="any" min="0"
									value="<?= $junio1; ?>" style="font-size: .9em;"
									onkeyup="EditIF(<?= $idReporte; ?>,<?= $id; ?>,6,1)"></td>
							<td class="align-middle p-0"><input id="D17<?= $id; ?>"
									class="form-control border-0 rounded-0 text-end" type="number" step="any" min="0"
									value="<?= $julio1; ?>" style="font-size: .9em;"
									onkeyup="EditIF(<?= $idReporte; ?>,<?= $id; ?>,7,1)"></td>
							<td class="align-middle p-0"><input id="D18<?= $id; ?>"
									class="form-control border-0 rounded-0 text-end" type="number" step="any" min="0"
									value="<?= $agosto1; ?>" style="font-size: .9em;"
									onkeyup="EditIF(<?= $idReporte; ?>,<?= $id; ?>,8,1)"></td>
							<td class="align-middle p-0"><input id="D19<?= $id; ?>"
									class="form-control border-0 rounded-0 text-end" type="number" step="any" min="0"
									value="<?= $septiembre1; ?>" style="font-size: .9em;"
			...
			<table class="table table-sm table-bordered mb-0" style="font-size: .9em;">
				...
				<tbody>
					...
					while ($rowP2 = mysqli_fetch_array($resultP2, MYSQLI_ASSOC)) {
						...
						<tr>
							<td><?= $rowP2['detalle']; ?></td>
							<td class="align-middle p-0"><input id="D21<?= $id; ?>"
									class="form-control border-0 rounded-0 text-end" type="number" step="any" min="0"
									value="<?= $enero2; ?>" style="font-size: .9em;"
									onkeyup="EditIF(<?= $idReporte; ?>,<?= $id; ?>,1,2)"></td>
							<td class="align-middle p-0"><input id="D22<?= $id; ?>"
									class="form-control border-0 rounded-0 text-end" type="number" step="any" min="0"
									value="<?= $febrero2; ?>" style="font-size: .9em;"
									onkeyup="EditIF(<?= $idReporte; ?>,<?= $id; ?>,2,2)"></td>
							<td class="align-middle p-0"><input id="D23<?= $id; ?>"
									class="form-control border-0 rounded-0 text-end" type="number" step="any" min="0"
									value="<?= $marzo2; ?>" style="font-size: .9em;"
									onkeyup="EditIF(<?= $idReporte; ?>,<?= $id; ?>,3,2)"></td>
							<td class="align-middle p-0"><input id="D24<?= $id; ?>"
									class="form-control border-0 rounded-0 text-end" type="number" step="any" min="0"
									value="<?= $abril2; ?>" style="font-size: .9em;"
									onkeyup="EditIF(<?= $idReporte; ?>,<?= $id; ?>,4,2)"></td>
							<td class="align-middle p-0"><input id="D25<?= $id; ?>"
									class="form-control border-0 rounded-0 text-end" type="number" step="any" min="0"
									value="<?= $mayo2; ?>" style="font-size: .9em;"
									onkeyup="EditIF(<?= $idReporte; ?>,<?= $id; ?>,5,2)"></td>
							<td class="align-middle p-0"><input id="D26<?= $id; ?>"
									class="form-control border-0 rounded-0 text-end" type="number" step="any" min="0"
									value="<?= $junio2; ?>" style="font-size: .9em;"
									onkeyup="EditIF(<?= $idReporte; ?>,<?= $id; ?>,6,2)"></td>
							<td class="align-middle p-0"><input id="D27<?= $id; ?>"
									class="form-control border-0 rounded-0 text-end" type="number" step="any" min="0"
									value="<?= $julio2; ?>" style="font-size: .9em;"
									onkeyup="EditIF(<?= $idReporte; ?>,<?= $id; ?>,7,2)"></td>
							<td class="align-middle p-0"><input id="D28<?= $id; ?>"
									class="form-control border-0 rounded-0 text-end" type="number" step="any" min="0"
									value="<?= $agosto2; ?>" style="font-size: .9em;"
									onkeyup="EditIF(<?= $idReporte; ?>,<?= $id; ?>,8,2)"></td>
							<td class="align-middle p-0"><input id="D29<?= $id; ?>"
									class="form-control border-0 rounded-0 text-end" type="number" step="any" min="0"
									value="<?= $septiembre2; ?>" style="font-size: .9em;"
