...
$eliminar = '<img src="'.RUTA_IMG_ICONOS.'eliminar.png" onclick="EliminarEdi('.$IdReporte.','.$id.','.$row_lista1['id'].')">';
}else{
...
echo '<td><a href="../../archivos/'.$row_lista1['pdf'].'" download><img src="'.RUTA_IMG_ICONOS.'pdf.png"></a></td>';
echo '<td><a href="../../archivos/'.$row_lista1['xml'].'" download><img src="'.RUTA_IMG_ICONOS.'xml.png"></a></td>';
