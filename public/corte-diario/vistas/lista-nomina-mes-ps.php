...
$sql_lista = "SELECT * FROM op_recibo_nomina WHERE departamento = '".$esdep."' AND year='".$GET_year."' AND mes='".$GET_mes."' AND periodo = '".$nombreSemana."' ORDER BY fecha ASC ";
...
<div class="border p-3 mt-3">
    ...
    <div class="row">
    <div class="col-12">
    <img class="ml-2 float-end pointer" onclick="Mas(9,<?=$GET_year;?>,<?=$GET_mes;?>,<?=$GET_semana;?>)" src="<?=RUTA_IMG_ICONOS;?>agregar.png">
    </div>
    </div>
...
<?php
$sql_lista2 = "SELECT * FROM op_recibo_nomina WHERE id_estacion = 9 AND year ='".$GET_year."' AND mes ='".$GET_mes."' AND periodo = '".$nombreSemana."' ORDER BY fecha ASC";
...
$SubirPDF = '<img class="grayscale" src="'.RUTA_IMG_ICONOS.'pdf-subir.png"  data-toggle="tooltip" data-placement="top" title="Subir Recibo de Nomina">';
 ...
 $editarNomina = '<img class="pointer" onclick="editarNomina('.$id.','.$idEstacion.','.$GET_year.','.$GET_mes.','.$GET_semana.','.$id_personal_nomina.')" src="'.RUTA_IMG_ICONOS.'editar-tb.png" data-toggle="tooltip" data-placement="top" title="Editar">';
 ...
 $SubirPDF = '<img class="pointer" src="'.RUTA_IMG_ICONOS.'pdf-subir.png" onclick="SubirPDF('.$id.','.$idEstacion.','.$GET_year.','.$GET_mes.','.$GET_semana.','.$id_personal_nomina.')" data-toggle="tooltip" data-placement="top" title="Subir Recibo de Nomina">';
...
echo "<tr><td colspan='20' class='text-center text-secondary'><small>No se encontró información para mostrar </small></td></tr>";
}
?>
