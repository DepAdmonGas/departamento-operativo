...
<html lang="es">
  ...
  function PreciosCombustibleY(year,mes){
  ...
  <li class="breadcrumb-item"><a onclick="history.go(-1)"  class="text-uppercase text-primary pointer"> Precios diarios de combustible</a></li>
  <li aria-current="page" class="breadcrumb-item active text-uppercase"><?=$GET_idyear?></li>
  </ol>
  </div>
 
  <div class="row"> 
  <div class="col-12"> <h3 class="text-secondary" style="padding-left: 0; margin-bottom: 0; margin-top: 0;">Precios diarios de combustible <?=$GET_idyear?></h3> </div>
  </div>
  ...
  <article class="plan card2 border-0 shadow position-relative" onclick="PreciosCombustibleY('.$GET_idyear.','.$i.')">
