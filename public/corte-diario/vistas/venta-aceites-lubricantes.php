...
$importe = $row_listaaceites['cantidad'] * $row_listaaceites['precio_unitario'];
    ...
    <tr>
    	...
    	<td class="p-0 align-middle">
    		<input id="cantidadAL-<?=$idAceite;?>" type="number" min="0" style="border: 0px;width: 100%;padding: 3px;height: 100%; text-align: center;" onkeyup="EditALCantidad(this,<?=$idReporte;?>,<?=$idAceite;?>)" value="<?=$cantidad;?>" <?=$estado;?>>
    	</td>
      <!-- <td class="align-middle text-end" id="precioAL-<?=$idAceite;?>"> -->
    	<td class="align-middle text-end">

        <input id="precioAL-<?=$idAceite;?>" type="number" min="0" style="border: 0px;width: 100%;padding: 3px;height: 100%; text-align: center;" onkeyup="EditALPrecio(this,<?=$idReporte;?>,<?=$idAceite;?>)" value="<?=$preciounitario;?>">
    		<!--<?=$precio;?> -->
    	</td>
