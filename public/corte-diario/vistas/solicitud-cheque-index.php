...
<html lang="es">
  ...
  <div class="border-0 p-3">
    ...
    <img class="float-start pointer <?=$ocultarleft?>" src="<?=RUTA_IMG_ICONOS;?>regresar.png" onclick="Regresar()">
  ...
  <div class="card card-menuB rounded shadow-sm pointer" onclick="SolicitudCheque('.$year.')">
