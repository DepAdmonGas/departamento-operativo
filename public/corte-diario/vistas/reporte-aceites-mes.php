...
<tbody>
  ...
  $iconDiferencia = '<div class="float-start"><img src="'.RUTA_IMG_ICONOS.'merma-no.png" onclick="ModalDetalle('.$idaceite.')"></div>';
    ...
    ?>
	  ...
	  <tr>
    <td class="align-middle p-1 text-center"><?=$row_listaaceites['id'];?></td>
		<td class="align-middle p-1"><b><?=$row_listaaceites['id_aceite'];?></b></td>
		...
		<td id="inventarioi-<?=$idaceite;?>" class="align-middle bg-light text-end"><?=number_format($inventarioI,2);?></td>

		<td class="align-middle p-0" ><input id="pedido-<?=$idaceite;?>" class="<?=$disabledStyle;?>" type="number" name="" style="border: 0px;width: 100%;padding: 3px;height: 100%; text-align: right;" value="<?=$pedido;?>" onkeyup="EditPedido(this,<?=$idaceite;?>)" <?=$disabled;?>></td>

    <td id="ventas-<?=$idaceite;?>" class="align-middle bg-light text-end"><?=$totalaceites;?></td>

		<td id="inventariof-<?=$idaceite;?>" class="align-middle bg-light text-end"><?=number_format($inventarioF,2);?></td>

		<td class="align-middle p-0" ><input id="fisicoB-<?=$idaceite;?>" class="<?=$disabledStyle;?>" type="number" name="" style="border: 0px;width: 100%;padding: 3px;height: 100%; text-align: right;" value="<?=$inventario_bodega;?>"  onkeyup="EditFisicoBodega(this,<?=$idaceite;?>)" <?=$disabled;?>></td>

        <td class="align-middle p-0" ><input id="fisicoE-<?=$idaceite;?>" class="<?=$disabledStyle;?>" type="number" name="" style="border: 0px;width: 100%;padding: 3px;height: 100%; text-align: right;" value="<?=$inventario_exibidores;?>"  onkeyup="EditFisicoExhibidor(this,<?=$idaceite;?>)" <?=$disabled;?>></td>

        <td class="align-middle text-end" id="fisicoFin-<?=$idaceite;?>"><?=valRow($inventario_final);?></td>

		<td id="diferencia-<?=$idaceite;?>" class="align-middle bg-light text-end"><?=number_format($diferencia,2);?> <?=$iconDiferencia;?></td>

    <td class="align-middle p-1 text-end">$ <?=number_format($difPrecio,2);?></td>

		<td class="align-middle p-0" ><input id="facturado-<?=$idaceite;?>" class="<?=$disabledStyle;?>" type="number" name="" style="border: 0px;width: 100%;padding: 3px;height: 100%; text-align: right;" value="<?=$producto_facturado;?>" onkeyup="EditFacturados(this,<?=$idaceite;?>)" <?=$disabled;?>></td>

		<td class="align-middle p-0" ><input id="mostrador-<?=$idaceite;?>" class="<?=$disabledStyle;?>" type="number" name="" style="border: 0px;width: 100%;padding: 3px;height: 100%; text-align: right;" value="<?=$factura_venta_mostrador;?>" onkeyup="EditMostrador(this,<?=$idaceite;?>)" <?=$disabled;?>></td>

		<td id="factotal-<?=$idaceite;?>" class="align-middle bg-light text-end"><?=number_format($factotal,2);?></td>

		<td id="diffactura-<?=$idaceite;?>" class="align-middle bg-light text-end"><?=number_format($diffactura,2);?></td>
