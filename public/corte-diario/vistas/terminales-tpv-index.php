          ...
          if (Modelomarca != '') {
            ...
            if (TipoC != '') {
              ...
              if (Afiliado != '') {
                            ...
                            if (EstadoTPV != '') {
                              ...
                              if (NoImpresiones != '') {
                                ...
                                if (TipoTPV != '') {
                                  ...
                                  $('#NoImpresiones').css('border', '2px solid red');
                                }
                              } else {
                                $('#NoImpresiones').css('border', '2px solid red');
                              }
                            } else {
                              $('#EstadoTPV').css('border', '2px solid red');
                            }
                          } else {
                            $('#NoLote').css('border', '2px solid red');
                          }
                        } else {
                          $('#Pedestales').css('border', '2px solid red');
                        }
                      } else {
                        $('#Cargadores').css('border', '2px solid red');
                      }
                    } else {
                      $('#Rollos').css('border', '2px solid red');
                    }
                  } else {
                ...
                $('#Afiliado').css('border', '2px solid red');
              }
            } else {
              $('#TipoC').css('border', '2px solid red');
            }
          } else {
            $('#Modelomarca').css('border', '2px solid red');
          }
        } else {
          $('#Serie').css('border', '2px solid red');
        }
      } else {
        $('#Tpv').css('border', '2px solid red');
      }
    ...
    function FinalizarFalla(idFalla, idTPV, idEstacion) {
      ...
      if (Falla != '') {
        ...
        if (Atiende != '') {
          $('#Atiende').css('border', '');
          if (NoReporte != '') {
            $('#NoReporte').css('border', '');
            if (DiaReporte != '') {
              $('#DiaReporte').css('border', '');
              if (DiaSolucion != '') {
                $('#DiaSolucion').css('border', '');
                if (Costo != '') {
                  $('#Costo').css('border', '');
                  if (NuevaSerie != '') {
                    $('#NuevaSerie').css('border', '');
                    if (ModeloTPV != '') {
                      $('#ModeloTPV').css('border', '');
                      if (Conexion != '') {
                        $('#Conexion').css('border', '');
                        ...
                        $('#Conexion').css('border', '2px solid red');
                      }
                    } else {
                      $('#ModeloTPV').css('border', '2px solid red');
                    }
                  } else {
                    $('#NuevaSerie').css('border', '2px solid red');
                  }
                } else {
                  $('#Costo').css('border', '2px solid red');
                }
              } else {
                $('#DiaSolucion').css('border', '2px solid red');
              }
            } else {
              $('#DiaReporte').css('border', '2px solid red');
            }
          } else {
            $('#NoReporte').css('border', '2px solid red');
          }
        } else {
          $('#Atiende').css('border', '2px solid red');
        }
      } else {
        $('#Falla').css('border', '2px solid red');
      }
