...
<html lang="es">
  ...
  function DespachoFactura(year){
  window.location.href = "despacho-factura/" + year;
  }
...
<?php
  ...
  <div class="card card-menuB rounded shadow-sm pointer" onclick="DespachoFactura('.$year.')">
