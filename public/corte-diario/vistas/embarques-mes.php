...
$('#Embarque').css('border','2px solid #A52525');
 ...
 function Eliminar(IdReporte,id){
  ...
  $('#Modal').modal('show'); 
  $('#ModalEmbarques').load('../../public/corte-diario/vistas/modal-editar-embarques-mes.php?idReporte=' + idReporte + '&id='+id);
  }
...
<div class="LoaderPage"></div>
  ...
  <div class="border-0 p-3">
    ...
    <div class="col-11">
     ...
     <div class="col-1">
    <img class="float-end pointer" src="<?=RUTA_IMG_ICONOS;?>agregar.png" onclick="Mas(<?=$IdReporte;?>)">
    </div>
