...
$sql_r = "SELECT piezas FROM op_inventario_papeleria WHERE id_estacion = '".$Session_IDEstacion."' AND id_producto = '".$idProducto."' ";
...
$sql_rr = "SELECT unidad FROM op_papeleria_reporte_detalle WHERE id = '".$id."' ";
...
$sql = "DELETE FROM op_papeleria_reporte_detalle WHERE id = '".$id."' ";
