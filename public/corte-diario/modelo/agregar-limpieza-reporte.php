...
$sql_lista = "SELECT piezas FROM op_inventario_limpieza WHERE id_estacion = '".$Session_IDEstacion."' AND id_producto = '".$idProducto."' ";
...
$sql_detalle = "SELECT * FROM op_limpieza_reporte_detalle WHERE id_reporte = '".$idReporte."' AND id_producto = '".$idProducto."' ";
...
$sql = "UPDATE op_limpieza_reporte_detalle SET 
    unidad = '".$updateUnidad."'
    WHERE id_reporte = '".$idReporte."' AND id_producto = '".$idProducto."' ";

}else{

$sql = "INSERT INTO op_limpieza_reporte_detalle (
id_reporte,
id_producto,
unidad,
observaciones
