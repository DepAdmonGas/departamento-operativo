...
$sql_r = "SELECT * FROM op_limpieza_reporte_detalle WHERE id_reporte = '".$id."' ";
...
$sql_r = "SELECT piezas FROM op_inventario_limpieza WHERE id_estacion = '".$idEstacion."' AND id_producto = '".$producto."' ";
$result_r = mysqli_query($con, $sql_r);
$numero_r = mysqli_num_rows($result_r);
while($row_r = mysqli_fetch_array($result_r, MYSQLI_ASSOC)){
...
$sql = "DELETE FROM op_limpieza_reporte_detalle WHERE id_reporte = '".$id."' ";

if (mysqli_query($con, $sql)) {

$sql1 = "DELETE FROM op_limpieza_reporte WHERE id = '".$id."' ";
