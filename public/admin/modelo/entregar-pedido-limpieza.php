...
$sql_r = "SELECT * FROM op_pedido_limpieza_detalle WHERE id_pedido = '".$idReporte."' ";
...
$sql_r = "SELECT piezas FROM op_inventario_limpieza WHERE id_estacion = '".$idEstacion."' AND id_producto = '".$producto."' LIMIT 1 ";
$result_r = mysqli_query($con, $sql_r);
$numero_r = mysqli_num_rows($result_r);
