...
<html lang="es">
  ...
  sizeWindow(); 
    ...
    $('#ListaSolicitud').load('../public/admin/vistas/lista-camioneta-saveiro.php?tipo=' + tipoCodificado);
...
function EliminarRegistro(tipo,id){
 ...
 function(){
  ...
  <a class="pointer" onclick="SelTipo('Tarjeta de circulación ')">
    <i class="fa-solid fa-address-card" aria-hidden="true" style="padding-right: 10px;"></i>Tarjeta de circulación 
    </a>
  </li>
