...
$titulo = "Fichas de Deposito Faltante";
  ...
  function obtenerEstacionesConPuntajeMasAlto($tipo, $GET_year, $con) {
    ...
    echo '<div class="mt-0" id="chart_div_remision' . $GET_idEstacion . '' . $GET_year . '"></div>';
    echo '</div>';
    echo '</div>';
    echo '</div>';
    ...
    function drawChart' . $GET_idEstacion . '' . $GET_year . '() {
        ...
        var options = {
            ...
            title: "Cumplimiento de Notas de Remisión - '.nombreES($GET_idEstacion,$con).' \n\n", // Agrega el salto de línea con \n
            hAxis: {
                title: "Meses",
            },
            vAxis: {
...
function consultaPuntajeRemisionMes($GET_idEstacion,$GET_year,$GET_mes,$con){
    ...
    echo '<div class="border p-3">';
    echo '<div class="table-responsive">';
    echo '<div class="mt-0" id="chart_div_remision_ES' . $GET_year . '"></div>';
    echo '</div>';
    echo '</div>';
    echo '</div>';
    ...
    function drawChart' . $GET_year . '() {
        ...
        legend: "none",
        colors: ' . json_encode($data['colors']) . ',
        title: "Cumplimiento de Notas de Remisión (Anual) - Estaciones \n\n", // Agrega el salto de línea con \n
        hAxis: {
    ...
    echo '<div class="border p-3">';
    echo '<div class="table-responsive">';
    echo '<div class="mt-0" id="chart_div_factura' . $GET_idEstacion . '' . $GET_year . '"></div>';
    echo '</div>';
    echo '</div>';
    echo '</div>';
    ...
    function drawChart' . $GET_idEstacion . '' . $GET_year . '() {
        ...
        var options = {
            ...
            legend: "none",
            colors: ' . json_encode($data['colors']) . ',
            title: "Cumplimiento de Facturas - '.nombreES($GET_idEstacion,$con).' \n\n", // Agrega el salto de línea con \n
            hAxis: {
                title: "Meses",
            },
            vAxis: {
    ...
    function mostrarGraficoFacturaES($tipo, $GET_year, $con) {
        ...
        echo '<div class="border p-3">';
        echo '<div class="table-responsive">';
        echo '<div class="mt-0" id="chart_div_factura_ES' . $GET_year . '"></div>';
        echo '</div>';
        echo '</div>';
        echo '</div>';
        ...
        function drawChart' . $GET_year . '() {
            ...
            legend: "none",
            colors: ' . json_encode($data['colors']) . ',
            title: "Cumplimiento de Facturas (Anual) - Estaciones \n\n", // Agrega el salto de línea con \n
            hAxis: {
                title: "Estacion(es) con mejor cumplimiento: \n  '.implode(", ", $mejorPuntaje['estaciones']).' - Puntaje: '.$mejorPuntaje['puntaje'].' de 108",
            },
            vAxis: {
    ...
    echo '<div class="border p-3">';
    echo '<div class="table-responsive">';
    echo '<div class="mt-0" id="chart_div_factura_venta' . $GET_idEstacion . '' . $GET_year . '"></div>';
    echo '</div>';
    echo '</div>';
    echo '</div>';
    ...
    function drawChart' . $GET_idEstacion . '' . $GET_year . '() {
        ...
        var options = {
            ...
            legend: "none",
            colors: ' . json_encode($data['colors']) . ',
            title: "Cumplimiento de Facturas Venta Mostrador - '.nombreES($GET_idEstacion,$con).' \n\n", // Agrega el salto de línea con \n
            hAxis: {
                title: "Meses",
            },
            vAxis: {
    ...
    function mostrarGraficoVentaMostradorES($tipo, $GET_year, $con) {
        ...
        echo '<div class="border p-3">';
        echo '<div class="table-responsive">';
        echo '<div class="mt-0" id="chart_div_factura_venta_ES' . $GET_year . '"></div>';
        echo '</div>';
        echo '</div>';
        echo '</div>';
        ...
        function drawChart' . $GET_year . '() {
            ...
            legend: "none",
            colors: ' . json_encode($data['colors']) . ',
            title: "Cumplimiento de Facturas Venta Mostrador (Anual) - Estaciones \n\n", // Agrega el salto de línea con \n
            hAxis: {
    ...
    echo '<div class="border p-3">';
    echo '<div class="table-responsive">';
    echo '<div class="mt-0" id="chart_div_faltantes_aceites' . $GET_idEstacion . '' . $GET_year . '"></div>';
    echo '</div>';
    echo '</div>';
    echo '</div>';
    ...
    function drawChart' . $GET_idEstacion . '' . $GET_year . '() {
        ...
        var options = {
            ...
            legend: "none",
            colors: ' . json_encode($data['colors']) . ',
            title: "Cumplimiento de Fichas de Deposito Faltante - '.nombreES($GET_idEstacion,$con).' \n\n", // Agrega el salto de línea con \n
            hAxis: {
                title: "Meses",
            },
            vAxis: {
...
function consultaPuntajeFaltantesAceitesMes($GET_idEstacion,$GET_year,$GET_mes,$con){
    ...
    function mostrarGraficoFaltantesAceitesES($tipo, $GET_year, $con) {
        ...
        echo '<div class="border p-3">';
        echo '<div class="table-responsive">';
        echo '<div class="mt-0" id="chart_div_faltantes_aceites_ES' . $GET_year . '"></div>';
        echo '</div>';
        echo '</div>';
        echo '</div>';
...
<div class="col-1">
<img class="float-end pointer" onclick="InfoEvaluacion(<?=$tipo?>)" src="<?=RUTA_IMG_ICONOS;?>info-tb.png">
</div>
</div>
