...
<div class="col-12">
<h5>Pedido limpieza <?=$estacion;?></h5>
</div>

<!--
<div class="col-4">
<img class="ms-2 pointer float-end" width="24px" src="<?=RUTA_IMG_ICONOS;?>control-despacho.png" onclick="ReporteLimpieza(<?=$idEstacion;?>)"> 
<img class="ms-2 pointer float-end" src="<?=RUTA_IMG_ICONOS;?>almacen-tb.png" onclick="AlmacenLimpieza(<?=$idEstacion;?>)">
</div>
-->
