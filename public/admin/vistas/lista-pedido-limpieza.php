...
$sql_lista = "SELECT * FROM op_pedido_limpieza WHERE id_estacion = '" . $idEstacion . "' ORDER BY id DESC";
...
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
  <div aria-label="breadcrumb" style="padding-left: 0; margin-bottom: 0;">
    <ol class="breadcrumb breadcrumb-caret">
      ...
      <li aria-current="page" class="breadcrumb-item active text-uppercase"> Pedido Limpieza<?= $Estacion ?></li>
    </ol>
  </div>

  <div class="row">
    <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12">
      <h3 class="text-secondary" style="padding-left: 0; margin-bottom: 0; margin-top: 0;"> Pedido
        Limpieza<?= $Estacion ?></h3>
    </div>
      ...
      <div class="text-end">
        <div class="dropdown d-inline">
          ...
          <ul class="dropdown-menu">
            <li onclick="NuevoPedido(<?=$Session_IDEstacion?>)">
...
<div class="table-responsive">
  <table id="tabla_limpieza_<?=$idEstacion?>" class="custom-table " style="font-size: .8em;" width="100%">
