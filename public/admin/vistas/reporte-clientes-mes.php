...
<td class="text-end font-weight-light">$ '.number_format($saldofinalC,2).'</td>
</tr>';
...
<td class="text-end font-weight-light">$ '.number_format($saldofinalD,2).'</td>
</tr>';
...
echo '<tr>
<td colspan="3"><b>Total Débito</b></td>
...
<tr>
<td colspan="3" class="font-weight-bold">GRAN TOTAL</td>
