...
$sql_comen = "SELECT * FROM op_camioneta_saveiro_comentarios WHERE id_documento = '".$idDocumento."' ORDER BY id DESC ";
...
<button type="button" class="btn btn-primary" onclick="GuardarComentario('<?=$tipo?>',<?=$idDocumento?>)">Guardar</button>
</div>
