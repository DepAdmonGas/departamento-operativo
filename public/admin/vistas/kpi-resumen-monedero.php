...
<div class="LoaderPage"></div>
  ...
  <div class="border-0 p-3">
    ...
    <div class="row">
    <div class="col-11"><h5>Evaluacion Facturas de Monederos (KPI's) <?=$GET_year?></h5></div>
    <div class="col-1"> <img class="float-end pointer" onclick="InfoEvaluacion(101)" src="<?=RUTA_IMG_ICONOS;?>info-tb.png"> </div>
