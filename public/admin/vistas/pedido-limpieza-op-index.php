...
<html lang="es">
  ...
  sizeWindow();
    ...
    if (sessionStorage.getItem('idestacion') !== undefined && sessionStorage.getItem('idestacion')) {
      ...
      $('#ContenidoPrin').load('../public/admin/vistas/lista-pedido-limpieza-op.php?idEstacion=' + idestacion);
  ...
  sizeWindow();
  $('#ContenidoPrin').load('../public/admin/vistas/lista-pedido-limpieza-op.php?idEstacion=' + id);
  }
