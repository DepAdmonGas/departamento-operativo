  ...
  <div id="content">
    ...
    <div class="contendAG">
        ...
        <div class="col-12">
          <div aria-label="breadcrumb" style="padding-left: 0; margin-bottom: 0;">
            <ol class="breadcrumb breadcrumb-caret">
              ...
              <li class="breadcrumb-item"><a onclick="history.go(-2)" class="text-uppercase text-primary pointer">
                  Análisis de compra </a></li>
      ...
      for ($i = 1; $i <= 12; $i++) {
        ...
        echo '
        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12 mb-2 mt-2 ' . $icon . '">
          <article class="plan card2 border-0 shadow position-relative" onclick="CoreteDiarioM(' . $GET_year . ',' . $i . ')">
            <div class="inner">
              <div class="row">
