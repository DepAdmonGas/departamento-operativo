...
<div class="table-responsive">
  <table class="custom-table" style="font-size: .75em;" width="100%">
    ...
    <tr>
      <th class="text-center align-middle tableStyle" colspan="18">MONEDEROS</th>
      <th class="text-center align-middle tableStyle" colspan="2">CRÉDITO</th>
    ...
    <tr class="title-table-bg">
      ...
      <th class="text-center align-middle <?= $ocultarProsegur ?>">Billete Matutino</th>
      <th class="text-center align-middle <?= $ocultarProsegur ?>">Billete Vespertino</th>
      <th class="text-center align-middle <?= $ocultarProsegur ?>">Billete Nocturno</th>
      <th class="text-center align-middle <?= $ocultarProsegur ?>">Morralla</th>
      <th class="text-center align-middle <?= $ocultarProsegur ?>">Deposito Bancario</th>
      <th class="text-center align-middle <?= $ocultarProsegur ?>">Cheque 1</th>
  ...
  -->
      ...
      <td class="align-middle text-end <?= $ocultarProsegur ?>">
        <strong>$
          <?= number_format($ToBilleteM, 2); ?>
        </strong>
      </td>

      <td class="align-middle text-end <?= $ocultarProsegur ?>">
        <strong>$
          <?= number_format($ToBilleteV, 2); ?>
        </strong>
      </td>

      <td class="align-middle text-end <?= $ocultarProsegur ?>">
        <strong>$
          <?= number_format($ToBilleteN, 2); ?>
        </strong>
      </td>

      <td class="align-middle text-end <?= $ocultarProsegur ?>">
        <strong>$
          <?= number_format($ToMorralla, 2); ?>
        </strong>
      </td>

      <td class="align-middle text-end <?= $ocultarProsegur ?>">
        <strong>$
          <?= number_format($ToDesposito, 2); ?>
        </strong>
      </td>

      <td class="align-middle text-end <?= $ocultarProsegur ?>">
        <strong>$
          <?= number_format($ToCheque1, 2); ?>
        </strong>
      </td>

      <td class="align-middle text-end <?= $ocultarProsegur ?>">
        <strong>$
          <?= number_format($ToTransferencia1, 2); ?>
        </strong>
      </td>

      <td class="align-middle text-end <?= $ocultarProsegur ?>">
        <strong>$
          <?= number_format($ToCheque2, 2); ?>
        </strong>
      </td>

      <td class="align-middle text-end <?= $ocultarProsegur ?>">
        <strong>$
          <?= number_format($ToTransferencia2, 2); ?>
        </strong>
      </td>

      <td class="align-middle text-end <?= $ocultarProsegur ?>">
        <strong>$
          <?= number_format($Toprosegur, 2); ?>
        </strong>
      </td>
