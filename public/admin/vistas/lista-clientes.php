...
<div class="font-weight-bold text-primary" style="font-size: 1em;">Crédito</div>
...
<th class="text-center align-middle"><small>Carta de crédito</small></th>
<th class="text-center align-middle"><small>Acta constitutiva</small></th>
<th class="text-center align-middle"><small>Comprobante de domicilio</small></th>
<th class="text-center align-middle"><small>Identificación</small></th>
<th width="20px" class="text-center align-middle"><img src="<?=RUTA_IMG_ICONOS;?>editar-tb.png" width="20px"></th>
...
echo '<tr>
<td class="align-middle text-center font-weight-light"  style="font-size: .9em;">'.$row_credito['cuenta'].'</td>
...
<div class="border p-3">
<div class="font-weight-bold  text-success" style="font-size: 1em;">Débito</div>
