...
WHERE YEAR(re_reporte_cre_producto.fecha) = '".$_GET['Year']."' AND MONTH (re_reporte_cre_producto.fecha) = '".$_GET['Month']."' ORDER BY re_reporte_cre_producto.fecha ASC, re_reporte_cre_mes.id_estacion ASC";
