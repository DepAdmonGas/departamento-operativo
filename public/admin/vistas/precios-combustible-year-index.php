    ...
    <div class="contendAG">
      <div class="row">
        ...
        <div class="col-12">
          <div aria-label="breadcrumb" style="padding-left: 0; margin-bottom: 0;">
            <ol class="breadcrumb breadcrumb-caret">
              ...
              <li class="breadcrumb-item"><a onclick="history.go(-1)" class="text-uppercase text-primary pointer">
                  Precios diarios de combustible</a></li>
          ...
          <div class="row">
            <div class="col-12">
              <h3 class="text-secondary" style="padding-left: 0; margin-bottom: 0; margin-top: 0;">Precios diarios de
                combustible <?= $GET_idyear ?></h3>
            </div>
          </div>
