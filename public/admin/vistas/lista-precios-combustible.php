...
$sql_lista = "SELECT * FROM op_formato_precios WHERE year = '".$year."' AND mes = '".$mes."'  ORDER BY fecha ASC";
...
echo '<td class="align-middle text-center"><img class="pointer" src="'.RUTA_IMG_ICONOS.'editar-tb.png" onclick="editarFormatoPrecio('.$id.')"></td>';
echo '<td class="align-middle text-center"><img class="pointer" src="'.RUTA_IMG_ICONOS.'eliminar.png" onclick="eliminarPreciosD('.$id.')"></td>';
echo '</tr>';
