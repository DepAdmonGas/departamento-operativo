...
$sql_comen = "SELECT * FROM op_refacciones_transaccion_comentarios WHERE id_op_refacciones_transaccion = '".$idReporte."' ORDER BY id_op_refacciones_transaccion DESC ";
...
<span class="btn-label2"><i class="fa fa-check"></i></span>Success</button>
</div>
