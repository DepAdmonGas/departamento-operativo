...
<li class="breadcrumb-item"><a class="text-uppercase pointer"> Despacho VS Ventas</a></li>
</ol>
</div>
          
<div class="row">
<div class="col-xl-11 col-lg-11 col-md-11 col-sm-12">
<h3 class="text-secondary" style="padding-left: 0; margin-bottom: 0; margin-top: 0;"> Ingresos VS Facturación</h3>
</div>
</div>
</div>
...
while ($row_listayear = mysqli_fetch_array($result_listayear, MYSQLI_ASSOC)) {
  ...
  <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 mb-2 mt-2">
    <article class="plan card2 border-0 shadow position-relative" onclick="IngresosFacturacion(' . $year . ')">
      <div class="inner">
        <div class="row">
