    ...
    <nav id="sidebar">
      ...
      ' . $estacion .
        ...
        if ($session_nompuesto != "Contabilidad" && $session_nompuesto != "Comercializadora") {
          ...
          <!--
  <li>
    <a class="pointer" onclick="SelControlV(11,<?= $GET_year; ?>,<?= $GET_mes; ?>)">
    <i class="fa-solid fa-gas-pump" aria-hidden="true" style="padding-right: 10px;"></i>
    <strong>Sabino Aguirre</strong></a>
  </li>

  <li>
    <a class="pointer" onclick="SelControlV(12,<?= $GET_year; ?>,<?= $GET_mes; ?>)">
    <i class="fa-solid fa-gas-pump" aria-hidden="true" style="padding-right: 10px;"></i>
    <strong>Acueducto de Guadalupe</strong></a>
  </li>

  <li>
    <a class="pointer" onclick="SelControlV(13,<?= $GET_year; ?>,<?= $GET_mes; ?>)">
    <i class="fa-solid fa-gas-pump" aria-hidden="true" style="padding-right: 10px;"></i>
    <strong>Tultepec</strong></a>
  </li>
  -->
      ...
      <div class="contendAG">
        <div class="row">
          ...
          <div class="col-12 mb-3">
            <div id="ListaCorte" class="cardAG"></div>
          </div>
