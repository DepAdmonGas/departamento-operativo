...
<html lang="es">
  ...
  function ResumenMonederoY(year){
  window.location.href = "resumen-monedero/" + year;
...
<?php
  ...
  <div class="card card-menuB rounded shadow-sm pointer" onclick="ResumenMonederoY('.$year.')">
