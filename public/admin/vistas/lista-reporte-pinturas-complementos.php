...
$sql_lista = "SELECT * FROM op_pinturas_complementos_reporte WHERE id_estacion = '".$idEstacion."' ORDER BY id DESC";
...
<div class="border-0 p-3">
    ...
    <img class="float-start pointer" src="<?=RUTA_IMG_ICONOS;?>regresar.png"  onclick="PedidoPinturasReturn(<?=$idEstacion;?>)"> 
    
    <div class="row">
    <div class="col-12">

    <h5>Reporte de pinturas <?=$estacion;?></h5>
