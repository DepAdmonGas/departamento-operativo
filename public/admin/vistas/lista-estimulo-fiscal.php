...
<button type="button" class="btn btn-primary float-end" style="margin-top: 29px;" onclick="BuscarReporte(<?=$idEstacion;?>)">Buscar Reporte</button>
</div>
...
<tr>
	<td colspan="2" class="text-right">TOTAL DE LITROS COMPRADOS</td>
	<td class="text-right bg-light"><b><?=number_format($Total);?></b></td>
</tr>
<tr>
	<td colspan="2" class="text-right">TOTAL A PAGAR</td>
	<td class="text-right bg-light"><b>$ <?=number_format($totalPesos,2);?></b></td>
</tr>
</tbody>
</table>
</div>
