...
<div class="table-responsive">
        <table class="table table-sm table-bordered table-striped table-hover" style="font-size: .8em">
          <thead class="tables-bg">
            ...
            if($ProductoDos != ""){
            echo '<th class="text-center align-middle bg-premium" colspan="2">'.$ProductoDos.'</th>';	
            }

            if($ProductoTres != ""){
            echo '<th class="text-center align-middle bg-diesel" colspan="2">'.$ProductoTres.'</th>  ';	
            }
          ...
          if($ProductoUno != ""){          
          echo "<td class='align-middle'>".number_format($Producto1['TotalLitros'],2)."</td>";
          echo "<td class='align-middle text-end'>$".number_format($Producto1['TotalPrecio'],2)."</td>";
          }

          if($ProductoDos != ""){
          echo "<td class='align-middle'>".number_format($Producto2['TotalLitros'],2)."</td>";
          echo "<td class='align-middle text-end'>$".number_format($Producto2['TotalPrecio'],2)."</td>";
          }

          if($ProductoTres != ""){          
          echo "<td class='align-middle'>".number_format($Producto3['TotalLitros'],2)."</td>";
          ...
          if($ProductoUno != ""){
          echo '<td><b>'.number_format($P1TL,2).'</b></td>
          <td class="text-end"><b>$'.number_format($P1TP,2).'</b></td>';
          }

          if($ProductoDos != ""){
          echo '<td><b>'.number_format($P2TL,2).'</b></td>
          <td class="text-end"><b>$'.number_format($P2TP,2).'</b></td>';
          }

          if($ProductoTres != ""){
          echo '<td><b>'.number_format($P3TL,2).'</b></td>
