...
<div class="col-11">
<h5>Pedido papelería <?=$estacion;?></h5>
</div>

<div class="col-1">
<img class="ms-2 float-end pointer" src="<?=RUTA_IMG_ICONOS;?>agregar.png" onclick="NuevoPedido(<?=$idEstacion;?>)">
<!--
<img class="ms-2 float-end pointer" width="24px" src="<?=RUTA_IMG_ICONOS;?>control-despacho.png" onclick="ReportePapeleria(<?=$idEstacion;?>)">
<img class="ms-2 float-end pointer" src="<?=RUTA_IMG_ICONOS;?>almacen-tb.png" onclick="AlmacenPapeleria(<?=$idEstacion;?>)">
-->
...
$Editar = '<img class="pointer" onclick="EditarPedido('.$idEstacion.','.$id.')" src="'.RUTA_IMG_ICONOS.'editar-tb.png"';
