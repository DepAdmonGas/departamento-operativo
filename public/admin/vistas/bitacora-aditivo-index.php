...
<html lang="es">
  ...
  sizeWindow();
    ...
    if (sessionStorage.getItem('idestacion') !== undefined && sessionStorage.getItem('idestacion')) {
      ...
      idEstacion = sessionStorage.getItem('idestacion');
       ...
       $('#Inventario').load('../public/admin/vistas/bitacora-aditivo.php?idEstacion=' + idEstacion);
  ...
  sessionStorage.setItem('idestacion', idEstacion);
  $('#Inventario').load('../public/admin/vistas/inventario-aditivo.php?idEstacion=' + idEstacion);
  } 
...
function Resumen(){
  ...
  sessionStorage.setItem('idestacion', idEstacion);
  $('#Inventario').load('../public/admin/vistas/reporte-aditivo.php?idEstacion=' + idEstacion);
  } 
...
?> 
 ...
 <nav class="navbar navbar-expand navbar-light navbar-bg" >
  ...
  <div id="Inventario" class="cardAG">
  ...
  <div class="col-10">
  <h5>Resumen inventario de aditivo</h5>
  </div>


  <div class="col-2">
  <img class="float-end pointer" src="<?=RUTA_IMG_ICONOS;?>pdf.png" onclick="PDF()">
  </div>
