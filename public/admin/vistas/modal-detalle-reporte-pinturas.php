...
<div class="col-xl-5 col-lg-5 col-md-12 col-sm-12 mb-2"> 
    <h6 class="mb-2 text-secondary ">Personal:</h6>
    <div class=""><?=$personal;?></div>
  </div>

<div class="col-xl-5 col-lg-5 col-md-12 col-sm-12 mb-2"> 
    <h6 class="mb-2 text-secondary ">Fecha:</h6>
    <div class=""><?=$fecha;?></div>
  </div>
...
<div class="col-xl-2 col-lg-2 col-md-12 col-sm-12 mb-2"> 
    ...
    <h6 class="mb-2 text-secondary ">Hora:</h6>
    <div class=""><?=$hora;?></div>
  </div>
</div>
...
<div class="row">
  <div class="col-12">
      <h6 class="mb-2 text-secondary">Detalle:</h6>
    <div class=""><?=$detalle;?></div>
  </div>
</div>

<h6 class="mb-2 text-secondary mt-1">Pinturas y complementos</h6>
