...
<div class="LoaderPage"></div>
  ...
  <hr>
          ...
          echo '<b>'.FormatoFecha($fecha).'</b> <hr>';
...
$RetotalVV = $RetotalVV + $volumenv;
$RetotalISI = $RetotalISI + $importesiniva;
$RetotalIV2 = $RetotalIV2 + $iva2;
$RetotalIEPS2 = $RetotalIEPS2 + $ieps2;
$Retotalneto = $Retotalneto + $total;
?>
    ...
    $RetotalPrecio = $Totalaceites['Totalimporte'];
    $Reaceitessiniva = $RetotalPrecio / 1.16;
    $Reaceitesiva = $Reaceitessiniva * 0.16;
    ?>
      <tr>
    <td colspan="5" class="align-middle text-end">SUBTOTAL COMBUSTIBLES</td>
    <td class="align-middle text-end"><strong><?=number_format($RetotalVV,2);?></strong></td>
    <td class="align-middle text-end"><strong><?=number_format($RetotalISI,2);?></strong></td>
    <td class="align-middle text-end"><strong><?=number_format($RetotalIV2,2);?></strong></td>
    <td class="align-middle text-end"><strong><?=number_format($RetotalIEPS2,2);?></strong></td>
      <td class="align-middle text-end"><strong><?=number_format($Retotalneto,2);?></strong></td>
  </tr>
  <tr>
    <td colspan="6" class="align-middle text-end">ACEITES</td>
    <td class="align-middle text-end"><?=number_format($Reaceitessiniva,2);?></td>
    <td class="align-middle text-end"><?=number_format($Reaceitesiva,2);?></td>
    <td></td>
    <td class="align-middle text-end"><?=number_format($RetotalPrecio,2);?></td>
  </tr>
  <tr>
    <?php
    $Retotaldiasi = $RetotalISI + $Reaceitessiniva;
    $Retotaldiaiva = $RetotalIV2 + $Reaceitesiva;
    $Retotaldia = $Retotalneto + $RetotalPrecio;
    ?>
    <td colspan="6" class="align-middle text-end">TOTAL DEL DÍA</td>
    <td class="align-middle text-end"><strong><?=number_format($Retotaldiasi,2);?></strong></td>
    <td class="align-middle text-end"><strong><?=number_format($Retotaldiaiva,2);?></strong></td>
    <td class="align-middle text-end"><strong><?=number_format($RetotalIEPS2,2);?></strong></td>
      <td class="align-middle text-end"><strong><?=number_format($Retotaldia,2);?></strong></td>
  </tr>
  <?php
  }else{
    echo "<tr><td colspan='10' class='align-middle text-center p-3'>No se encontró información para mostrar </td></tr>";
