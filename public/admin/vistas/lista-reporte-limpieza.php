...
$sql_lista = "SELECT * FROM op_limpieza_reporte WHERE id_estacion = '".$idEstacion."' ORDER BY id DESC";
...
<div class="border-0 p-3">
    ...
    <h5>Reporte de artículos de limpieza <?=$estacion;?></h5>
...
$Editar = '<img src="'.RUTA_IMG_ICONOS.'editar.png" onclick="EditarReporte('.$idEstacion.','.$id.')">';
$Eliminar = '<img src="'.RUTA_IMG_ICONOS.'eliminar.png" onclick="EliminarReporte('.$idEstacion.','.$id.')">';
}else if($status == 1){
$tableColor = "";
...
echo '<td class="align-middle text-center"><img class="pointer" src="'.RUTA_IMG_ICONOS.'ver-tb.png" onclick="ModalDetalleReporte('.$idEstacion.','.$id.')"></td>';
echo '</tr>';
