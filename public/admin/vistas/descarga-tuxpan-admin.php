...
<html lang="es">
  ...
  function Detalle(id){
  window.location.href = "../administracion/descarga-tuxpan-detalle/" + id;   
    } 
...
<table class="table table-sm table-bordered table-striped mb-0" style="font-size: 1em">
...
$responsable = Responsable($row_lista['id_usuario'],$con);
...
echo '<tr>
      ...
      <td class="align-middle text-center" onclick="Detalle('.$id.')"><img class="pointer" src="'.RUTA_IMG_ICONOS.'ver-tb.png"></td>
