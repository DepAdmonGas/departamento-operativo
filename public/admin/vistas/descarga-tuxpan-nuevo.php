...
<html lang="es">
  ...
  <div class="row">
  <div class="col-12"> 
  <h5>Crear formato de descarga merma</h5>
  <hr> 
  </div>
  </div>
  ...
  <div class="col-12 col-sm-6 mb-2">
    ...
    <select class="form-select" id="Estacion" onchange="BuscarEstacion(this)" <?=$Disabled;?>>
  ...
  <input type="number" class="form-control" id="CuentaLitros" onkeyup="mermaLts(this,2)">  
  </div>
  ...
  <input class="form-check-input" type="radio" name="Radios1" id="SellosAlterados1" style="width: 18px; height: 18px;margin-top: 4px;" >
  ...
  <div class="form-check">
  <input class="form-check-input" type="radio" name="Radios1" id="SellosAlterados2" style="width: 18px; height: 18px;margin-top: 4px;">
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="Radios2" id="sdvdld1" style="width: 18px; height: 18px;margin-top: 4px;">
    <label class="form-check-label" for="sdvdld1" style="margin-left: 10px;">
      SI
    </label>
  </div>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="Radios2" id="sdvdld2" style="width: 18px; height: 18px;margin-top: 4px;">
  ...
  <button type="button" class="btn btn-sm btn-primary float-end" onclick="clear1()">Limpiar</button>
  </div>
  </div>
  ...
  <button type="button" class="btn btn-sm btn-primary float-end" onclick="clear2()">Limpiar</button>
  </div>
  </div>
  </div>
  <hr>
  ...
  <div class="row">
  <div class="col-12">
  <button class="btn btn-success btn-block p-2 mb-2 mt-2 float-end" onclick="GuardarFirmar()">Guardar y Finalizar</button>
  </div>
  </div>
