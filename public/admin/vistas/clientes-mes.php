...
<html lang="es">
  ...
  $('#DivReporteClientes').load('../../../../public/admin/vistas/reporte-clientes-mes.php?IdReporte=' + IdReporte);  
  }
...
<div class="LoaderPage"></div>
  ...
  <div class="border-0 p-3">
    ...
    <div class="row">
    <div class="col-12">
    <h5>Clientes, <?=nombremes($GET_mes);?> <?=$GET_year;?></h5>
    </div>
    </div>
    ...
    <button type="button" class="btn btn-info btn-sm float-end text-white" onclick="Actualizar(<?=$IdReporte;?>,<?=$GET_idEstacion;?>,<?=$GET_year;?>,<?=$GET_mes;?>)">
      Actualizar
    </button>
    </div> 
    <?php } ?>
