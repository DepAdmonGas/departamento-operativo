...
<html lang="es">
  ...
  function ResumenAceitesY(year){
  window.location.href = "resumen-aceites/" + year;
...
<?php
  ...
  <div class="card card-menuB rounded shadow-sm pointer" onclick="ResumenAceitesY('.$year.')">
