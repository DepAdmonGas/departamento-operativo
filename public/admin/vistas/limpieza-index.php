...
<head>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function ($) {
      ...
      if (sessionStorage) {
        if (sessionStorage.getItem('idestacion') !== undefined && sessionStorage.getItem('idestacion')) {
          ...
          pedidoLimpieza(idEstacion)
        }
      }
    });

    function pedidoLimpieza(idEstacion) {
      let targets;
      targets = [4,5];
    ...
    function ListaLimpieza() {
      let targets;
      targets = [3,4];
      $('#ContenidoPrin').load('../public/admin/vistas/lista-producto-limpieza.php', function () {
        $('#tabla-principal').DataTable({
          "language": {
            "url": '<?= RUTA_JS2 ?>' + "/es-ES.json"
          },
      ...
      <ul class="list-unstyled components">
        ...
        <li>
          <a class="pointer" onclick="ListaLimpieza()">
            <i class="fa-solid fa-list" aria-hidden="true" style="padding-right: 10px;"></i>Catálogo de artículos de
            limpieza
          </a>
        </li>
