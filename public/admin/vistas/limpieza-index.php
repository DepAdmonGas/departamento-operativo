...
<html lang="es">
  ...
  sizeWindow();
    ...
    if (sessionStorage.getItem('idestacion') !== undefined && sessionStorage.getItem('idestacion')) {
      ...
      $('#ContenidoPrin').load('../public/admin/vistas/lista-pedido-limpieza.php?idEstacion=' + idestacion);
  ...
  sizeWindow();
  $('#ContenidoPrin').load('../public/admin/vistas/lista-pedido-limpieza.php?idEstacion=' + id);
  }
  ...
  function ListaLimpieza(){
  sizeWindow(); 
  $('#ContenidoPrin').load('../public/admin/vistas/lista-producto-limpieza.php');
  }

  function ModalNevo(){
  $('#Modal').modal('show');  
  $('#ContenidoModal').load('../public/admin/vistas/modal-agregar-producto-limpieza.php?idProducto=0');  
  }
  ...
  var Unidad = $('#Unidad').val();
   ...
   $('#Unidad').css('border','');
    ...
    $.ajax({
    data:  parametros,
    url:   '../public/admin/modelo/agregar-editar-limpieza.php',
    type:  'post',
    beforeSend: function() {
    },
    complete: function(){
 ...
 function(){
      ...
      $.ajax({
    data:  parametros,
    url:   '../public/admin/modelo/eliminar-producto-limpieza.php',
    type:  'post',
    beforeSend: function() {
    },
    complete: function(){
 ...
 function(){
  ...
  $('#Modal').modal('show');  
  $('#ContenidoModal').load('../public/admin/vistas/modal-agregar-producto-limpieza.php?idProducto=' + id); 
  }
  //------------------------------------------------------------------------------------------------------------
  //------------------------------------------------------------------------------------------------------------
...
function NuevoPedido(idEstacion){
 ...
 var parametros = {
    "idEstacion" : idEstacion
      ...
      $.ajax({
    data:  parametros,
    url:   '../public/admin/modelo/agregar-reporte-pedido-limpieza.php',
    type:  'post',
    beforeSend: function() {
    },
    complete: function(){
  ...
  $('#Modal').modal('show');  
  $('#ContenidoModal').load('../public/admin/vistas/modal-agregar-pedido-limpieza.php?idEstacion=' + idEstacion + '&idReporte=' + response); 
  sizeWindow()
...
var Piezas = $('#Piezas').val();
   ...
   var parametros = {
    ...
    $.ajax({
    data:  parametros,
    url:   '../public/admin/modelo/agregar-producto-pedido-limpieza.php',
    type:  'post',
    beforeSend: function() {
    },
    complete: function(){
    ...
    if (response == 1) {
     $('#ContenidoModal').load('../public/admin/vistas/modal-agregar-pedido-limpieza.php?idEstacion=' + idEstacion + '&idReporte=' + idReporte); 
    }else{
    alertify.error('Error al agregar el producto');
    }
...
function VerPedido(idEstacion,id){
  $('#Modal').modal('show');  
  $('#ContenidoModal').load('../public/admin/vistas/modal-detalle-pedido-limpieza.php?idEstacion=' + idEstacion +'&idReporte=' + id); 
}
...
function EliminarItem(id,idEstacion,idReporte){
 ...
 function(){
      ...
      $.ajax({
    data:  parametros,
    url:   '../public/admin/modelo/eliminar-producto-pedido-limpieza.php',
    type:  'post',
    beforeSend: function() {
    },
    complete: function(){
...
function PedidoEntregado(idEstacion,idReporte){
 ...
 function(){
      ...
      $.ajax({
    data:  parametros,
    url:   '../public/admin/modelo/entregar-pedido-limpieza.php',
    type:  'post',
    beforeSend: function() {
    },
    complete: function(){
...
function EliminarPedido(idEstacion,idReporte){
 ...
 function(){
      ...
      $.ajax({
    data:  parametros,
    url:   '../public/admin/modelo/eliminar-pedido-limpieza.php',
    type:  'post',
    beforeSend: function() {
    },
    complete: function(){
...
//---------------------------------------------------------------------------------------------------
    ...
    $.ajax({
    data:  parametros,
    url:   '../public/admin/modelo/editar-item-pedido-limpieza.php',
    type:  'post',
    beforeSend: function() {
    },
    complete: function(){
  ...
  function AlmacenLimpieza(id){
  $('#ContenidoPrin').load('../public/admin/vistas/lista-inventario-limpieza.php?idEstacion=' + id);
  } 

  function ModalNevoInventario(idEstacion){
  $('#Modal').modal('show');  
  $('#ContenidoModal').load('../public/admin/vistas/modal-agregar-inventario-limpieza.php?idEstacion=' + idEstacion);  
  }
  ...
  var parametros = {
   ...
   $('#Piezas').css('border','');
    ...
    $.ajax({
    data:  parametros,
    url:   '../public/admin/modelo/agregar-inventario-limpieza.php',
    type:  'post',
    beforeSend: function() {
    },
    complete: function(){
...
function EliminarInventario(id,idEstacion){
 ...
 function(){
      ...
      $.ajax({
    data:  parametros,
    url:   '../public/admin/modelo/eliminar-inventario-limpieza.php',
    type:  'post',
    beforeSend: function() {
    },
    complete: function(){
...
function ReporteLimpieza(id){
$('#ContenidoPrin').load('../public/admin/vistas/lista-reporte-limpieza.php?idEstacion=' + id);  
} 

      function ModalDetalleReporte(idEstacion,id){      
    $('#Modal').modal('show');  
    $('#ContenidoModal').load('../public/admin/vistas/modal-detalle-reporte-limpieza.php?idEstacion=' + idEstacion + '&idReporte=' + id );
    }

//-----------------------------------------------------------------------------------

function FirmarPedido(idEstacion,id){
window.location.href = "pedido-limpieza-firmar/" + id;
}
  </script>
  </head>
...
<div class="LoaderPage"></div>
  ...
  <li>
    <a class="pointer" onclick="ListaLimpieza()">
    <i class="fa-solid fa-list" aria-hidden="true" style="padding-right: 10px;"></i>Catálogo de artículos de limpieza
    </a>
  </li>
...
?> 
 ...
 <nav class="navbar navbar-expand navbar-light navbar-bg" >
  ...
  <div class="pointer">
  <a class="text-dark" onclick="history.back()">Pedido de Artículos de limpieza</a>
  </div>
