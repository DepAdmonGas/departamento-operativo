          ...
          <div class="cardAG">
            <div class="border-0 p-3">
              ...
              <div class="row">
                  ...
                  <div aria-label="breadcrumb" style="padding-left: 0; margin-bottom: 0;">
                    <ol class="breadcrumb breadcrumb-caret">
                      <li class="breadcrumb-item"><a onclick="history.back()"
                          ...
                          Proveedores</a></li>
                      <li aria-current="page" class="breadcrumb-item active">EDITAR PROVEEDOR</li>
                    </ol>
                  </div>

                  <div class="row">
                    <div class="col-12">
                      <h3 class="text-secondary" style="padding-left: 0; margin-bottom: 0; margin-top: 0;">Editar
                        Proveedor</h3>
                    </div>
                  </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-2">
                  <div class="mb-2 text-secondary">BANCO:</div>
