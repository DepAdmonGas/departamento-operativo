...
<thead>
	<tr>
		<th colspan="2" class="align-middle text-center bg-white">Concepto</th>
    <th class="align-middle text-center bg-white">Pzas caja</th>
    <th class="align-middle text-center bg-white">Precio Unitario</th>
    <th class="align-middle text-center bg-white">Bodega</th>
    <th class="align-middle text-center bg-white">Exhibidores</th>
    <th class="align-middle text-center bg-white">Inventario Inicial</th>
    <th class="align-middle text-center bg-white">Compras / Pedido</th>
    <th class="align-middle text-center bg-white">Ventas del mes</th>
    <th class="align-middle text-center bg-white">Inventario Final</th>
    <th class="align-middle text-center bg-white">Inventario fisico Bodega</th>
    <th class="align-middle text-center bg-white">Inventario fisico Exhibidores</th>
    <th class="align-middle text-center bg-white">Inventario fisico Final</th>
    <th class="align-middle text-center bg-white">Diferencia</th>
    <th class="align-middle text-center bg-white">Diferencia $</th>
    <th class="align-middle text-center bg-white">Prod. Facturados</th>
    <th class="align-middle text-center bg-white">Factura venta mostrador</th>
    <th class="align-middle text-center bg-white">Fac. total</th>
    <th class="align-middle text-center bg-white">Dif. En Facturacion</th>
		<?php
		for ($Pdia = 1; $Pdia <= $Udia; $Pdia++) {
			echo "<th class='align-middle text-center bg-white'>".$Pdia."</th>";
		}
		?>
		...
		?>
    <th class="align-middle text-center bg-white">Total</th>
	</tr>
</thead>
<tbody>
	<?php
  ...
  $sql_listaaceite = "SELECT piezas FROM op_aceites WHERE id_aceite = '".$noaceite."' LIMIT 1 ";
    ...
    $ventas = valRow($row_listaaceites['ventas']);
    $inventario_fisico = valRow($row_listaaceites['inventario_fisico']);
    ...
    ?>
	<tr>
		<td class="align-middle p-1"><?=$row_listaaceites['id_aceite'];?></td>
    ...
    <td class="align-middle p-1 text-end"><?=number_format($diferencia,2);?> <?=$iconDiferencia;?></td>
