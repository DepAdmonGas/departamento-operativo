...
<div class="tooltip1">
<img class="ms-1 mb-2 pointer" onclick="ControlVolumetrico(<?=$idEstacion;?>,<?=$GET_year;?>,<?=$GET_mes;?>)" src="<?=RUTA_IMG_ICONOS;?>control-volumetrico.png">
  <div class="bottom">Control volumétrico</div>
</div>

<div class="tooltip1">
<img class="ms-1 mb-2 pointer" onclick="ResumenMonedero(<?=$idEstacion;?>,<?=$GET_year;?>,<?=$GET_mes;?>)" src="<?=RUTA_IMG_ICONOS;?>monedero.png">
  <div class="bottom">Resumen Monedero</div>
</div>

<div class="tooltip1">
<img class="ms-1 mb-2 pointer" onclick="Clientes(<?=$idEstacion;?>,<?=$GET_year;?>,<?=$GET_mes;?>)" src="<?=RUTA_IMG_ICONOS;?>clientes.png">
  <div class="bottom">Clientes</div>
</div>

<div class="tooltip1">
<img class="ms-1 mb-2 pointer" onclick="ConcentradoVentas(<?=$idEstacion;?>,<?=$GET_year;?>,<?=$GET_mes;?>)" src="<?=RUTA_IMG_ICONOS;?>concentrado-ventas.png">
...
<div class="tooltip1">
<img class="ms-1 mb-2 pointer" onclick="Aceites(<?=$idEstacion;?>,<?=$GET_year;?>,<?=$GET_mes;?>)" src="<?=RUTA_IMG_ICONOS;?>aceite.png">
...
<div class="tooltip1">
<img class="ms-1 mb-2 pointer" onclick="AperturaCorteKPI(<?=$idEstacion;?>,<?=$GET_year;?>,<?=$GET_mes;?>)" src="<?=RUTA_IMG_ICONOS;?>grafico.png">
