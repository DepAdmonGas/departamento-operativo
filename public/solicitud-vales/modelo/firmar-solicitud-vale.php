...
$sql = "SELECT * FROM op_solicitud_vale_token WHERE id_solicitud = '".$idReporte."' and id_usuario = '".$Session_IDUsuarioBD."' and token = '".$TokenValidacion."' ORDER BY id ASC LIMIT 1 ";
$result = mysqli_query($con, $sql);
$numero = mysqli_num_rows($result);

if($numero == 1){

$sql = "UPDATE op_solicitud_vale SET 
status = '".$estado."'
WHERE id = '".$idReporte."' ";

if(mysqli_query($con, $sql)){

$sql_insert2 = "INSERT INTO op_solicitud_vale_firma (
id_solicitud,
id_usuario,
tipo_firma,
firma
...
$detalle = 'Se firmo con visto bueno una solicitud de vales de la estación '.$session_nomestacion;
