...
function notificacionesWA($Numero, $aleatorio,$token)
{
    ...
    $mensaje = '{
        ...
        "text": {
        "preview_url": "false",
        "body": "AdmonGas: Usa el siguiente token para firmar la solicitud de vale solicitada. Token: ' . $aleatorio . ' Web: portal.admongas.com.mx"
      }
    }';
...
$idVal = $_POST['idVal'];
$sql = "DELETE FROM op_solicitud_vale_token WHERE id_solicitud = '" . $idReporte . "' AND id_usuario = '" . $Session_IDUsuarioBD . "' ";

if (mysqli_query($con, $sql)) {

    $aleatorio = rand(100000, 999999);

    $sql_insert = "INSERT INTO op_solicitud_vale_token (
id_solicitud,
id_usuario,
token
    )
    ...
    if (mysqli_query($con, $sql_insert)) {
        ...
        if ($idVal == 1) {
            ...
            $response = $altiriaSMS->sendSMS($sDestination, "AdmonGas: Usa el siguiente token para firmar la solicitud de vale solicitada. Token: " . $aleatorio . " Web: portal.admongas.com.mx");
