...
<button type="button" class="btn btn-primary" onclick="GuardarComentario(<?=$year;?>,<?=$mes;?>,<?=$idEstacion;?>,<?=$depu;?>,<?=$idReporte;?>,'<?=$orderFolio;?>','<?=$orderFecha;?>','<?=$orderCuenta;?>','<?=$orderMonto;?>','<?=$orderSolicitante;?>','<?=$buscarSolicitante;?>')">Guardar</button>
</div>
