...
<html lang="es">
  ...
  function SolicitudVales(year,mes){
  window.location.href = year + "/" + mes;
  }

  function SolicitudValesAdmin(year,mes){
  ...
  <div class="border-0 p-3">
    ...
    <div class="col-12">
     ...
     <h5>Solicitud de vales <?=$GET_year;?></h5>
...
<?php
  ...
  <div class="card '.$color.' rounded shadow-sm pointer" onclick="SolicitudValesAdmin('.$GET_year.','.$i.')">
  ...
  echo '  <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 mb-1 mt-2 ">
  <div class="card '.$color.' rounded shadow-sm pointer" onclick="SolicitudVales('.$GET_year.','.$i.')">
