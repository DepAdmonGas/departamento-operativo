...
$sql = "SELECT * FROM op_orden_compra_token WHERE id_ordencompra = '".$idReporte."' and id_usuario = '".$Session_IDUsuarioBD."' and token = '".$TokenValidacion."' ORDER BY id ASC LIMIT 1 ";
$result = mysqli_query($con, $sql);
$numero = mysqli_num_rows($result);

if($numero == 1){

$sql = "UPDATE op_orden_compra SET 
estatus = '".$estado."'
WHERE id = '".$idReporte."' ";
...
$detalle = 'Se firmo con visto bueno la orden de compra de la estación '.$session_nomestacion;
