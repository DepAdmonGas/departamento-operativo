...
<meta charset="utf-8">
  ...
  <script type="text/javascript">
    ...
    function OrdenCompraY(year) {
      window.location.href = "orden-compra/" + year;
    }
      ...
      <div class="row">
          ...
          <div aria-label="breadcrumb" style="padding-left: 0; margin-bottom: 0;">
            <ol class="breadcrumb breadcrumb-caret">
              <li class="breadcrumb-item"><a onclick="history.go(-1)" class="text-uppercase text-primary pointer"><i
                    ...
                    <li aria-current="page" class="breadcrumb-item active text-uppercase"> Orden de Compra</li>
            </ol>
          </div>
          <div class="row">
        ...
        for ($i = $fecha_year; $i >= 2023; $i--) {
          ...
          <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 mb-2 mt-2">
            <article class="plan card2 border-0 shadow position-relative" onclick="OrdenCompraY(' . $i . ')">
              <div class="inner">
                <div class="row">
