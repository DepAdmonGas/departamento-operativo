...
<html lang="es">
  ...
  $('#ListaFecha').load('../../../public/orden-compra/vistas/lista-orden-compra-estacion.php?year=' + year + '&mes=' + mes);
  }
 ...
 window.location.href = "../../orden-compra-descargar/" + idCompra;
  ...
  <div class="border-0 p-3">
    ...
    <img class="float-end pointer" onclick="Nuevo(<?=$GET_idYear;?>,<?=$GET_idMes;?>)" src="<?=RUTA_IMG_ICONOS;?>agregar.png">
    </div>
