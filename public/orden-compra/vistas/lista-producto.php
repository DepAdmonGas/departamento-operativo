       ...
       <table class="table table-sm table-bordered mb-0" style="font-size: .9em;">
        <thead>
          ...
          <tr class="bg-light">
            ...
            <th class="text-end <?=$ocultarTb?>" width="16px"><img src="<?=RUTA_IMG_ICONOS?>eliminar.png" width="20px"></th>
          </tr>
        </thead>
        <tbody>
		<?php
...
echo '<td colspan="10" class="text-center table-info"><b>Proveedor: '.$razonsocialP.'</b></td>';
echo '</tr>';
