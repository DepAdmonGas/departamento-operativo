...
<html lang="es">
  ...
  $('#ContenidoRefacturacion').load('../../public/orden-compra/vistas/lista-refacturacion.php?idReporte=' + idReporte);
  }
...
<div class="LoaderPage"></div>
  ...
  <div class="border p-3">
  <div class="text-end">
  <img src="<?=RUTA_IMG_ICONOS;?>agregar.png" class="pointer" onclick="ModalProveedor(<?=$GET_idReporte;?>)">
  </div>
  <hr>
  ...
  <div class="border p-3 mb-3">
    <div class="text-end">
    <img src="<?=RUTA_IMG_ICONOS;?>agregar.png" class="pointer" onclick="Producto(<?=$GET_idReporte;?>)">
    </div>
    <hr>
  ...
  <div class="border p-3 mb-3">
    ...
    <div class="text-end">
    <img src="<?=RUTA_IMG_ICONOS;?>agregar.png" class="pointer" onclick="Refacturacion(<?=$GET_idReporte;?>)">
    </div>
...
<hr>
  <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-2">  
    <div class="mb-2 text-secondary text-center mt-3">FIRMA ELABORÓ</div>
...
<?php if($session_nompuesto == "Dirección de operaciones"){ ?>
  ...
  <button type="button" class="btn btn-primary" onclick="Finalizar(<?=$GET_idReporte;?>,'A')">Guardar</button>
  </div>
 <?php }?>
