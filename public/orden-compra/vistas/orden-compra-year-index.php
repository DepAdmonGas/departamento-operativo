...
<meta charset="utf-8">
  ...
  <script type="text/javascript">
    ...
    function OrdenCompraY(year, mes) {
      ...
      <div class="row">
        ...
        for ($i = 1; $i <= 12; $i++) {
          ...
          <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12 mb-2 mt-2 ' . $icon . '">
            <article class="plan card2 border-0 shadow position-relative" onclick="OrdenCompraY(' . $GET_idyear . ',' . $i . ')">
              <div class="inner">
                <div class="row">
                  <div class="col-2"> <span class="pricing"> <i class="fa-solid fa-calendar-days"></i></span> </div>
                  <div class="col-10">
                    <h5 class="text-white text-center">' . nombremes($i) . ' ' . $GET_idyear . '</h5>
                  </div>
                </div>
              </div>
            </article>
