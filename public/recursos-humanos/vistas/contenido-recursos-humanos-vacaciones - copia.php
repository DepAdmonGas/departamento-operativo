...
<div class="col-2">
<img class="float-end pointer" src="<?=RUTA_IMG_ICONOS;?>agregar.png" onclick="Formulario(5,<?=$idEstacion;?>)">
<img class="float-end pointer" src="<?=RUTA_IMG_ICONOS;?>buscar.png" onclick="ModalBuscar(<?=$idEstacion;?>)">
</div>
</div>
<hr>
...
<thead class="tables-bg">
  ...
  <tr>
    ...
    <th class="align-middle">Fecha regreso</th>
