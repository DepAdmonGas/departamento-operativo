...
$sql_comen = "SELECT * FROM op_recibo_nomina_comentarios WHERE id_nomina = '".$idNomina."' ORDER BY id DESC ";
...
<button type="button" class="btn btn-primary" onclick="GuardarComentario(<?=$idNomina?>,<?=$idEstacion?>,<?=$year?>,<?=$mes?>,<?=$semana?>)">Guardar</button>
