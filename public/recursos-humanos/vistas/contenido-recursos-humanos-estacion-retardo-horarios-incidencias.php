...
?>
    ...
    <h5>Retardo</h5>
    <div class="text-secondary mb-2">Agregar retardo en minutos:</div>
   
    <div class="input-group mb-2">
    <input type="number" id="Retardo" class="form-control rounded-0" placeholder="Retardo" aria-label="Retardo" min="0" value="<?=$retardo;?>" disabled>
    <span class="input-group-text rounded-0" id="basic-addon2">minutos</span>
    </div>

    <div class="text-end mt-2"><button class="btn btn-outline-primary rounded-0 btn-sm mt-2" type="button" onclick="Actualizar(<?=$idEstacion;?>)" disabled>Actualizar</button></div>
    </div> 

    <div class="border p-3 ">
    <h5>Incidencias</h5>

    <div class="fs-6 fw-light text-secondary mb-2">Agregar días para la resolución de Incidencias:</div>

    <div class="input-group mb-2">
    <input type="number" id="Incidencia" class="form-control rounded-0" placeholder="Incidencia" aria-label="Incidencia" min="0" value="<?=$incidencia;?>" disabled>
    <span class="input-group-text rounded-0" id="basic-addon2">días</span>    
    </div>

    <div class="text-end mt-2"><button class="btn btn-outline-primary rounded-0 btn-sm" type="button" onclick="Actualizar(<?=$idEstacion;?>)" disabled>Actualizar</button></div>
    </div>
    ...
    <h5>Horarios</h5>
    <div class="fw-light text-secondary mb-0">Lista de horarios  
...
<div class="table-responsive">
		...
		echo '<td class="text-center align-middle"> <img src="'.RUTA_IMG_ICONOS.'editar-tb.png" class="pointer" 
