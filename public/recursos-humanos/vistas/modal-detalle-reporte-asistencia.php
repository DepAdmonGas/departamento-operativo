...
function tablasNomina($GET_idEstacion,$GET_year,$GET_idMes,$GET_idSemana,$con){
	...
	<button type="button" class="btn btn-labeled2 btn-success">
    <span class="btn-label2"><i class="fa-regular fa-file-pdf"></i></span>Decargar Reporte Individual</button>        
    </a>';
    ...
    $resultado .= '<table class="custom-table" style="font-size: .8em;" width="100%">';
    ...
    $resultado .= '<tr>';
    $resultado .= '<th>'.$row_personal['nombre_completo'].'</th>';
    ...
    $resultado .= '<div class="modal-footer">'.$reporte.'</div>';
...
<h5 class="modal-title">Reporte asistencia - Semana <?=$semana?></h5>
<button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
</div>


<?php echo tablasNomina($idEstacion, $year, $mes, $semana, $con);?>
