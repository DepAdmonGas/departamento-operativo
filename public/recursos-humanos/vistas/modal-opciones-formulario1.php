...
<div class="text-end">
<button type="button" class="btn btn-primary btn-sm" onclick="GuardarPersonal(<?=$idEstacion;?>,<?=$idReporte;?>)">Agregar personal</button>
</div>
...
<thead>
	<tr class="tables-bg text-center">
		...
		<th class="align-middle text-center" width="20"><img src="<?=RUTA_IMG_ICONOS;?>eliminar.png" data-toggle="tooltip" data-placement="top" title="Eliminar"></th>
	</tr>
</thead> 
<tbody>
<?php
...
<button type="button" class="btn btn-success" onclick="Finalizar(<?=$idReporte;?>,<?=$idEstacion;?>)">Finalizar alta de personal</button>
</div> 
