...
<h5 class="modal-title">Detalle Restructuración de Personal</h5>
...
<tbody>
<tr>
	<td class="align-middle text-center">Ref. Alta y baja de personal</td>
...
<tr>
	...
	<td class="align-middle text-center"><b>010</b></td>
</tr>
</tbody>
</table>
</div>
...
<thead>
	<tr class="tables-bg">
		...
		<th class="align-middle text-right">Salario diario</th>
...
echo '<td class="align-middle text-center">'.number_format($row_lista['sd'],2).'</td>';
