...
$sql_usuario = "SELECT version FROM op_rol_comodines WHERE id_estacion = '".$idEstacion."' ORDER BY version desc LIMIT 1";
...
$upload_folder = "../../../archivos/rol-comodines/".$numeroAleatorio."-Rol de comodines-".$numeroAleatorio2 . "." . $extension1;
$Imagen = $numeroAleatorio."-Rol de comodines-".$numeroAleatorio2 . "." . $extension1;
...
$sql_insert = "INSERT INTO op_rol_comodines (
