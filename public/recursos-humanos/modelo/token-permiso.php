...
$sql = "DELETE FROM op_rh_permisos_token WHERE id_permiso = '".$idReporte."' AND id_usuario = '".$Session_IDUsuarioBD."' ";
...
$response = $altiriaSMS->sendSMS($sDestination, "AdmonGas: Usa el siguiente token para firmar el permiso solicitado. Token: ".$aleatorio." Web: portal.admongas.com.mx");
