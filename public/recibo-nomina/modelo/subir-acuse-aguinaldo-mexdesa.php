...
$UpDoc1 = "../../../archivos/recibos-nomina-v2/recibos-mexdesa/".$numeroAleatorio."-Acuses-Aguinaldo".$localidad.$numeroAleatorio2;
   
if(move_uploaded_file($_FILES['DocumentoAcuse_file']['tmp_name'], $UpDoc1)){
$NomDoc1 = $numeroAleatorio."-Acuses-Aguinaldo".$localidad.$numeroAleatorio2;
}
    
if($idAcuse != 0){
    
$sql_edit1 = "UPDATE op_recibo_nomina_aguinaldo SET 
doc_nomina_aguinaldo = '".$NomDoc1."'
WHERE id = '".$idAcuse."'";
...
$sql_insert1 = "INSERT INTO op_recibo_nomina_aguinaldo
(year,
mes,
no_semana_quincena,
descripcion,
