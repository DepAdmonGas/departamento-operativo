...
<head>
  ...
  <script type="text/javascript">
    ...
    function SelSemanasES(idEstacion, year, semana) {
      ...
      $(referencia).load('../public/recibo-nomina/vistas/lista-nomina-semanas.php?idEstacion=' + idEstacion + '&year=' + year + '&semana=' + semana);  
    }
    ...
    if(idEstacion == 9){
      $('#ListaNominaPS').load('../public/recibo-nomina/vistas/lista-nomina-semanas.php?idEstacion=' + idEstacion +  '&year=' + year + '&semana=' + semana);
    ...
    function SelQuincenasES(idEstacion, year, quincena) {
      ...
      if (<?= $Session_IDUsuarioBD ?> == 304 || <?= $Session_IDUsuarioBD ?> == 355 || <?= $Session_IDUsuarioBD ?> == 381 || <?= $Session_IDUsuarioBD ?> == 472 || <?= $Session_IDUsuarioBD ?> == 434){
        $('#ListaNomina2').load('../public/recibo-nomina/vistas/lista-nomina-quincenas.php?idEstacion=' + idEstacion + '&year=' + year + '&quincena=' + quincena);
          ...
          success: function (response) {
            ...
            if (response == 1) {
              ...
              if (descripcion == "Semana") {
                ...
                if (<?= $Session_IDUsuarioBD ?> == 304 || <?= $Session_IDUsuarioBD ?> == 355 || <?= $Session_IDUsuarioBD ?> == 381 || <?= $Session_IDUsuarioBD ?> == 472 || <?= $Session_IDUsuarioBD ?> == 434){
                  $('#ListaNomina2').load('../public/recibo-nomina/vistas/lista-nomina-quincenas.php?idEstacion=' + idEstacion + '&year=' + year + '&quincena=' + SemQui);
  ...
  <div id="content">
    ...
    <div class="contendAG">
      <div class="row">
        ...
        <div class="col-12 mb-3 <?= $noneDiv2 ?>">
          <div class="cardAG">
            <div class="border-0 p-3">
              ...
              <div class="row">
                ...
                <div class="col-12">
                  <div id="ListaNomina2" class="cardAG"></div>
                </div>
