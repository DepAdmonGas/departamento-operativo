...
<html lang="es">
  ...
  $('#ListaNominaEvaluacion').load('../public/recibo-nomina/vistas/lista-nomina-estaciones-evaluacion.php?idEstacion=' + idEstacion +  '&year=' + year + '&mes=' + mes);
  ...
  function SelEvaluacionES(idEstacion,year,mes){
    sizeWindow();
 ...
 <div class="wrapper"> 
  ...
  $SelEstacion = "onclick='SelEvaluacionES(".$id.",".$GET_year.",".$GET_mes_actual.")'";
