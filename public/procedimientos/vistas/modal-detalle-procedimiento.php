...
<iframe class="border-0 mt-2 mb-3" src="<?php echo RUTA_ARCHIVOS?>/procedimientos-modulos/<?=$archivo;?>" width="100%" height="600px">
</iframe>
...
<div class="modal-footer">
 ...
 <button type="button" class="btn btn-danger" onclick="eliminarProcedimiento(<?=$idProcedimiento?>,'<?=$GET_idModulo?>')">Eliminar</button>
</div>
