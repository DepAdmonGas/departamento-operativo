...
return $this;
	...
	//Como destinatarios se admite un array de tel´efonos, una cadena de tel´efonos
	//separados por comas o un ´unico tel´efonos
...
//Concat. Valores posibles true. Si no se especifica o es false, no se env´ıa
