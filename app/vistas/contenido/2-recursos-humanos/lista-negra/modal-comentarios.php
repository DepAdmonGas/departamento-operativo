...
$sql_comen = "SELECT * FROM op_rh_lista_negra_comentarios WHERE id_lista_negra = '".$idListaNegra."' ORDER BY id DESC ";
...
<button type="button" class="btn btn-labeled2 btn-success" onclick="GuardarComentario(<?=$idListaNegra?>)">
