...
<head>
  ...
  listaAjusteSalarial(<?=$GET_idReporte?>)

  }); 

  function listaAjusteSalarial(idReporte){
  $('#DivAjusteSalarial').load('../../app/vistas/contenido/2-recursos-humanos/formatos/5-ajuste-salarial/lista-ajuste-salarial.php?idReporte=' + idReporte);
  }

  // ---------- MODAL AGREGAR PERSONAL ----------//
  function modalAjusteSalarial(idReporte,idEstacion){
  $('#Modal').modal('show');  
  $('#ContenidoModal').load('../../app/vistas/contenido/2-recursos-humanos/formatos/5-ajuste-salarial/modal-ajuste-salarial.php?idReporte=' + idReporte + '&idEstacion=' + idEstacion);
  }
  ...
  data.append('AjusteSalario', AjusteSalario); 
  data.append('FechaAplicacion', FechaAplicacion); 
  data.append('accion', 'agregar-ajuste-salarial');
  ...
  $('#AjusteSalario').css('border','2px solid #A52525'); 
  }
  }else{
  ...
  var parametros = {
  "idUsuario" : idUsuario,
  "accion" : "eliminar-ajuste-salarial"
  };
  ...
  <li aria-current="page" class="breadcrumb-item active text-uppercase">Formulario Ajuste Salarial <?=$estacion?></li>
  </ol>
  </div>

  <div class="row">
  <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12">
  <h3 class="text-secondary" style="padding-left: 0; margin-bottom: 0; margin-top: 0;"> Formulario Ajuste Salarial <?=$estacion?></h3>
  </div>
                  
  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">       
  <button type="button" class="btn btn-labeled2 btn-primary float-end" onclick="modalAjusteSalarial(<?=$GET_idReporte?>,<?=$GET_idEstacion?>)">
  ...
  <div id="DivAjusteSalarial" class="col-12"></div>
