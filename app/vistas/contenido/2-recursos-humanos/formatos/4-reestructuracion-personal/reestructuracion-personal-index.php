...
<head>
  ...
  listaReestructuracionPersonal(<?=$GET_idReporte?>)

  }); 

  function listaReestructuracionPersonal(idReporte){
  $('#DivReestructuracionPersonal').load('../../app/vistas/contenido/2-recursos-humanos/formatos/4-reestructuracion-personal/lista-reestructuracion-personal.php?idReporte=' + idReporte);
  }

  // ---------- MODAL AGREGAR PERSONAL ----------//
  function modalEstructuraPersonal(idReporte,idEstacion){
  $('#Modal').modal('show');  
  $('#ContenidoModal').load('../../app/vistas/contenido/2-recursos-humanos/formatos/4-reestructuracion-personal/modal-reestructuracion-personal.php?idReporte=' + idReporte + '&idEstacion=' + idEstacion);
  }
  ...
  data.append('NombreEstacion', NombreEstacion); 
  data.append('FechaAplicacion', FechaAplicacion); 
  data.append('accion', 'agregar-personal-reestructuracion');
  ...
  $(".LoaderPage").hide();
  $('#Modal').modal('hide');  
  listaReestructuracionPersonal(idReporte);
  ...
  $('#NombreEstacion').css('border','2px solid #A52525'); 
  }
  }else{
  ...
  var parametros = {
  "idUsuario" : idUsuario,
  "accion" : "eliminar-personal-reestructuración"
  };
  ...
  <li aria-current="page" class="breadcrumb-item active text-uppercase">Formulario Reestructuración de Personal <?=$estacion?></li>
  </ol>
  </div>

  <div class="row">
  <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12">
  <h3 class="text-secondary" style="padding-left: 0; margin-bottom: 0; margin-top: 0;"> Formulario Reestructuración de Personal <?=$estacion?></h3>
  </div>
                  
  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">       
  <button type="button" class="btn btn-labeled2 btn-primary float-end" onclick="modalEstructuraPersonal(<?=$GET_idReporte?>,<?=$GET_idEstacion?>)">
  ...
  <div id="DivReestructuracionPersonal" class="col-12"></div>
