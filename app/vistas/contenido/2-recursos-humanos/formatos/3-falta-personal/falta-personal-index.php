...
<head>
  ...
  listaFaltaPersonal(<?=$GET_idReporte?>)

  });

  function listaFaltaPersonal(idReporte){
  $('#DivFaltaPersonal').load('../../app/vistas/contenido/2-recursos-humanos/formatos/3-falta-personal/lista-falta-personal.php?idReporte=' + idReporte);
  }

  // ---------- MODAL AGREGAR PERSONAL ----------//
  function modalBajaPersonal(idReporte,idEstacion){
  $('#Modal').modal('show');  
  $('#ContenidoModal').load('../../app/vistas/contenido/2-recursos-humanos/formatos/3-falta-personal/modal-falta-personal.php?idReporte=' + idReporte + '&idEstacion=' + idEstacion);
  }
  ...
  var FechaFalta = $('#FechaFalta').val();

  if(NombresCompleto != ""){
  $('#NombresCompleto').css('border','');
  if(FechaFalta != ""){
  $('#FechaFalta').css('border','');
  ...
  data.append('FechaFalta', FechaFalta); 

  data.append('accion', 'agregar-personal-falta');
  ...
  $('#FechaFalta').css('border','2px solid #A52525'); 
  }
  }else{
  ...
  var parametros = {
  "idUsuario" : idUsuario,
  "accion" : "eliminar-personal-falta"
  };
  ...
  <li aria-current="page" class="breadcrumb-item active text-uppercase">Formulario Falta de Personal <?=$estacion?></li>
  </ol>
  </div>

  <div class="row">
  <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12">
  <h3 class="text-secondary" style="padding-left: 0; margin-bottom: 0; margin-top: 0;"> Formulario Falta de Personal <?=$estacion?></h3>
  </div>
  ...
  <div id="DivFaltaPersonal" class="col-12"></div>
