...
?>
  ...
  <tr> <th class="align-middle text-start">ANEXO IV: EXPEDIENTE DE TRANPORTE PARA LA RECLAMACION DE PRODUCTO <br>La estación de servicio debe recabar:</th> </tr>
  </thead>
  <tbody>
  <tr class="no-hover">
  ...
  <th class="align-middle text-center bg-light" width="60"><?=$PDF?></th>
  ...
  <th class="align-middle text-center bg-light" width="60"><?=$XML?></th>
  </tr>
  ...
  <th class="align-middle text-center bg-light"><?=$CoPa?></th>
  ...
  <th class="align-middle text-center bg-light"><?=$NCPDF?></th>
  ...
  <th class="align-middle text-center bg-light"><?=$NCXML?></th>
  </tr>
  ...
  <th class="align-middle text-center bg-light"><?=$ComPDF?></th>
  ...
  <th class="align-middle text-center bg-light"><?=$ComXML?></th>
  </tr>
  ...
  <div class="modal-footer">
    <button type="button" class="btn btn-labeled2 btn-success float-end" onclick="EditarE(<?=$IdReporte;?>,<?=$id;?>,<?=$idestacion;?>,<?=$year;?>,<?=$mes;?>)">
