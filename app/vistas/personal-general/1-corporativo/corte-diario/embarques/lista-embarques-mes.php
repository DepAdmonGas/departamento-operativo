    ...
    <thead class="navbar-bg">
      <tr>
        ...
        <th class="align-middle text-center" width="24">
          <small>
            <div class="text-white">Factura</div>
          </small><img src="<?= RUTA_IMG_ICONOS; ?>pdf.png">
        </th>
        <th class="align-middle text-center" width="24">
          <small>
            <div class="text-white">Factura</div>
          </small><img src="<?= RUTA_IMG_ICONOS; ?>xml.png">
        </th>
        <th class="align-middle text-center" width="24">
          <small>
            <div class="text-white">CoPa</div>
          </small><img src="<?= RUTA_IMG_ICONOS; ?>descargar.png">
        </th>
        <th class="align-middle text-center" width="24">
          <small>
            <div class="text-white">NC</div>
          </small><img src="<?= RUTA_IMG_ICONOS; ?>pdf.png">
        </th>
        <th class="align-middle text-center" width="24">
          <small>
        ...
        <th class="align-middle text-center" width="24">
          <img src="<?= RUTA_IMG_ICONOS; ?>comentario-tb.png">
        </th>
        <th class="align-middle text-center" width="24">
          <img src="<?= RUTA_IMG_ICONOS; ?>editar-tb.png">
        </th>
        <th class="align-middle text-center" width="24">
    ...
    <tbody>
      ...
      if ($numero_lista > 0) {
        ...
        while ($row_lista = mysqli_fetch_array($result_lista, MYSQLI_ASSOC)) {
          ...
          if ($row_lista['pdf'] != "") {
            $PDF = '<a href="../../archivos/' . $row_lista['pdf'] . '" download data-toggle="tooltip" data-placement="top" title="Factura PDF"><img class="pointer" src="' . RUTA_IMG_ICONOS . 'pdf.png' . '"></a>';
          } else {
            $PDF = '<img src="' . RUTA_IMG_ICONOS . 'eliminar.png" data-toggle="tooltip" data-placement="top" title="Factura PDF">';
          }

          if ($row_lista['xml'] != "") {
            $XML = '<a href="../../archivos/' . $row_lista['xml'] . '" download><img class="pointer" src="' . RUTA_IMG_ICONOS . 'xml.png' . '" data-toggle="tooltip" data-placement="top" title="Factura XML"></a>';
          } else {
          ...
          if ($row_lista['comprobante_p'] != "") {
            $CoPa = '<a href="../../archivos/' . $row_lista['comprobante_p'] . '" download><img class="pointer" src="' . RUTA_IMG_ICONOS . 'descargar.png' . '" data-toggle="tooltip" data-placement="top" title="Comprobante de pago"></a>';
          } else {
          ...
          if ($row_lista['nc_pdf'] != "") {
            $NCPDF = '<a href="../../archivos/' . $row_lista['nc_pdf'] . '" download data-toggle="tooltip" data-placement="top" title="Nota de crédito PDF"><img class="pointer" src="' . RUTA_IMG_ICONOS . 'pdf.png' . '"></a>';
          } else {
            $NCPDF = '<img src="' . RUTA_IMG_ICONOS . 'eliminar.png" data-toggle="tooltip" data-placement="top" title="Nota de crédito PDF">';
          }

          if ($row_lista['nc_xml'] != "") {
            $NCXML = '<a href="../../archivos/' . $row_lista['nc_xml'] . '" download><img class="pointer" src="' . RUTA_IMG_ICONOS . 'xml.png' . '" data-toggle="tooltip" data-placement="top" title="Nota de crédito XML"></a>';
          } else {
