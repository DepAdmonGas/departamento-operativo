                                        ...
                                        <div class="dropdown d-inline ms-2">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li
                                                    ...
                                                    <a class="dropdown-item pointer"><i
                                                            class="fa-solid fa-bottle-droplet"></i> Control
                                                        volumetrico</a>
                                                </li>
                                                <li
                                                ...
                                                <li onclick="ResumenMonedero(<?= $GET_year; ?>,<?= $GET_mes; ?>)">
                                                    <a class="dropdown-item pointer"><i
                                                            class="fa-solid fa-money-bill-trend-up"></i> Resumen
                                                        monedero</a>
                                                </li>
                                                <li onclick="Aceites(<?= $GET_year; ?>,<?= $GET_mes; ?>)">
                                                    <a class="dropdown-item pointer"><i
                                                            class="fa-solid fa-oil-can"></i>
                                                        Resumen aceites</a>
                                                </li>
                                                ...
                                                <li onclick="Embarques(<?= $GET_year; ?>,<?= $GET_mes; ?>)">
                                                    <a class="dropdown-item pointer"><i
                                                            class="fa-solid  fa-truck-droplet"></i>
                                                        Resumen embarques</a>
                                                </li>
                                            </ul>
                                        </div>
