    ...
    <table id="tabla_bitacora" class="custom-table" style="font-size: .9em;" width="100%">
      ...
      <tbody class="bg-light">
        ...
        if ($numero_reporte > 0):
          ...
          <tr>
            <th colspan="5" class="align-middle text-end fw-bold">SUBTOTAL COMBUSTIBLES</th>
          ...
          <tr>
            <th colspan="6" class="align-middle text-end fw-bold">ACEITES</th>
          ...
          <tr>
            ...
            ?>
            <th colspan="6" class="align-middle text-end fw-bold">TOTAL DEL DÍA</th>
