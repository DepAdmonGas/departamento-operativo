              ...
              <div class="border-0 p-3">
                ...
                <div class="row">
                  ...
                  <div class="col-12">
                    <div aria-label="breadcrumb" style="padding-left: 0; margin-bottom: 0;">
                      <ol class="breadcrumb breadcrumb-caret">
                        ...
                        <li aria-current="page" class="breadcrumb-item active text-uppercase">Crear Solicitud de Cheque
                        </li>
                      </ol>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-12 mb-1">
                        <h3 class="text-secondary" style="padding-left: 0; margin-bottom: 0; margin-top: 0;"> Crear
                          Solicitud de Cheque</h3>
                      </div>
                    </div>
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-2">
                    ...
                    <select class="selectize pointer form-select rounded-0" id="CFDI">
                      <option>Selecciona una opcion...</option>
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-2">
                    ...
                    <select class="selectize pointer form-select rounded-0" id="FormaPago">
                      <option value="">Selecciona una opcion...</option>
                        ...
                        <tbody>
                          <tr class="no-hover">
                            <th class="align-middle text-center bg-light p-0">
                              <textarea class="form-control rounded-0 bg-light border-0" id="Observaciones"
                                style="height:190px" placeholder="Escribe aqui tu comentario..."></textarea>
                            </th>
                          </tr>
                        </tbody>
                      </table>
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-3">
                    <table class="custom-table" style="font-size: 14px;" width="100%">
                      <thead class="tables-bg">
                        <tr>
                          <th class="align-middle text-center">FIRMA DEL ENCARGADO</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          <th class="align-middle text-center p-0 no-hover2">
                            <div id="signature-pad" class="signature-pad ">
                              <div class="signature-pad--body ">
                                <canvas
                                  style="width: 100%; height: 150px; border-right: .1px solid #215d98; border-left: .1px solid #215d98; cursor: crosshair;"
                                  id="canvas"></canvas>
                              </div>
                  ...
                  <div class="col-12">
                    ...
                    <button type="button" class="btn btn-labeled2 btn-success float-end"
                      onclick="Guardar(<?= $GET_year ?>,<?= $GET_mes ?>)">
