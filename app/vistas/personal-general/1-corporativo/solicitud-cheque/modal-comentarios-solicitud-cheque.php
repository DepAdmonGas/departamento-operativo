...
echo '<div style="font-size: .75em;" class="mb-1 text-secondary">Información</div> 
        <div class="bg-light fw-light pt-2 pb-1 ps-3 pe-3 mb-3" style="font-size: .85em;border-radius: 25px;"><b>Fecha:</b> '.$ClassHerramientasDptoOperativo->FormatoFecha($row_lista['fecha']).', <b>Beneficiario:</b> '.$row_lista['beneficiario'].', <b>Monto:</b> $'.number_format($row_lista['monto'],2).', <b>No. Factura:</b> '.$row_lista['no_factura'].'</div>';
