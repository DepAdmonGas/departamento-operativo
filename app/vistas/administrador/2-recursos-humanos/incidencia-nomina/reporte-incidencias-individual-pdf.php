...
<?=tablasNomina($idEstacion, $year, $semana, $con)?>
...
$dompdf->stream("Reporte de incidencias ".$nombreEstacion." - Semana ".$semana.".pdf", ["Attachment" => 0]); // Attachment => false lo abre en el navegador
?>
